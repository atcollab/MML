function varargout = vacuum(varargin)

persistent CAHandle figHandle valueBoxHandle

if nargin == 0   
    
    PV = 'epicsuser1Host:Voltage';
    ...
    buttonHandle = uicontrol('Parent', figHandle, ...
                             ...
                             'String', 'Exit', ...
                             'Fontsize', 12, ...
                             'CallBack', 'vacuum exit');
                           
    set(figHandle,'Visible','on','CloseRequestFcn','vacuum exit');
