function varargout = examplex(varargin)

persistent CAHandle figHandle valueBoxHandle

if nargin == 0   
    
    PV = 'epicsadminHost:xxxExample';
    ...
    buttonHandle = uicontrol('Parent', figHandle, ...
                             ...
                             'String', 'Exit', ...
                             'Fontsize', 12, ...
                             'CallBack', 'examplex exit');
                           
    set(figHandle,'Visible','on','CloseRequestFcn','examplex exit');
    ...
    if ~CAHandle
        ...
        sts = mcamon(CAHandle, 'examplex go');
        if ~sts
