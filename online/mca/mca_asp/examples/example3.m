function varargout = example3(varargin)

persistent CAHandle figHandle valueBoxHandle

if nargin == 0   
    
    PV = 'epicsadminHost:aiExample3';
    ...
    buttonHandle = uicontrol('Parent', figHandle, ...
                             ...
                             'String', 'Exit', ...
                             'Fontsize', 12, ...
                             'CallBack', 'example3 exit');
                           
    set(figHandle,'Visible','on','CloseRequestFcn', 'example3 exit');
    ...
    if ~CAHandle
        ...
        sts = mcamon(CAHandle, 'example3 go');
        if ~sts
