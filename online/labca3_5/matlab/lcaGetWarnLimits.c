/* $Id: lcaGetWarnLimits.c,v 1.1 2008/05/22 00:17:36 till Exp $ */

/* matlab wrapper for ezcaGetWarnLimits */
...
LcaError theErr;
	...
	if ( !multi_ezca_get_misc(pvs.names, pvs.m, (MultiEzcaFunc)ezcaGetWarnLimits, NumberOf(args), args, &theErr) )
		goto cleanup;
