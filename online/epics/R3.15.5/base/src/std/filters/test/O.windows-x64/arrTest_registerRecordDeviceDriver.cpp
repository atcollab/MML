...
/* Generated from ../O.Common/arrTest.dbd */
...
epicsShareExtern rset *pvar_rset_arrRSET;
...
static const recordTypeLocation rtl[] = {
    {pvar_rset_arrRSET, pvar_func_arrRecordSizeOffset}
};

int arrTest_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* arrTest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"arrTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    arrTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
