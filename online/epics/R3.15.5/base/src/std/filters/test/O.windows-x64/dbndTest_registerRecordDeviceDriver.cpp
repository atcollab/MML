...
/* Generated from ../O.Common/dbndTest.dbd */
...
int dbndTest_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* dbndTest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"dbndTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    dbndTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
