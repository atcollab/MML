...
/* Generated from ../O.Common/tsTest.dbd */
...
int tsTest_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef rrddFuncDef =
    {"tsTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    tsTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
