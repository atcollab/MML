function [x, y, BPMxFamily, QUADxFamily, BPMyFamily, QUADyFamily] = quadplotall(DirName)
% ----------------------------------------------------------------------------------------------
% $Header: MatlabApplications/acceleratorcontrol/cls/quadplotall.m 1.2 2007/03/02 09:02:36CST matiase Exp  $
% ----------------------------------------------------------------------------------------------
...
dx = getlist('BPMx',0);
Xnew = 0 * ones(size(dx,1),size(X,2));
Xnew(:,1:2) = dx;
...
dy = getlist('BPMy',0);
Ynew = 0 * ones(size(dy,1),size(Y,2));
Ynew(:,1:2) = dy;
...
% ----------------------------------------------------------------------------------------------
% $Log: MatlabApplications/acceleratorcontrol/cls/quadplotall.m  $
% Revision 1.2 2007/03/02 09:02:36CST matiase 
% Added header/log
% ----------------------------------------------------------------------------------------------
