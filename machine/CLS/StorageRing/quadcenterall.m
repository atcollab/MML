% ----------------------------------------------------------------------------------------------
% $Header: MatlabApplications/acceleratorcontrol/cls/quadcenterall.m 1.2 2007/03/02 09:02:49CST matiase Exp  $
% ----------------------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%
% Make the BPM list %
%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:size(BPMDevList,1)
    ...
    if abs(DelSpos) < 1
        ...
        elseif DCCT < 14 && i<size(BPMDevList,1)-1
            sound(cos(1:10000));
            fprintf('   Current too low.  Refill and hit return.\n');
            pause;
            fprintf(' \n');
...
% ----------------------------------------------------------------------------------------------
% $Log: MatlabApplications/acceleratorcontrol/cls/quadcenterall.m  $
% Revision 1.2 2007/03/02 09:02:49CST matiase 
% Added header/log
% ----------------------------------------------------------------------------------------------
