function [k, B] = elsa2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%ELSA2AT - Converts control system values to the AT simulator values
%  [K, B] = elsa2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%
%  See also at2elsa, hw2physics, physics2hw
