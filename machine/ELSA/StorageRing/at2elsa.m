function [Value, B] = at2elsa(Family, Field, k, DeviceList, Energy, BranchFlag)
%AT2ELSA - Converts the AT simulator values to control system values
%  [Value, B] = at2elsa(Family, Field, K, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%
%  See also elsa2at, hw2physics, physics2hw
