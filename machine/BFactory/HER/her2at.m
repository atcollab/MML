function [k, B] = her2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%HER2AT - Converts control system values to simulator values
%  [K, B] = her2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%    error('her2at conversion needs to be programmed for %s.%s\n', Family, Field);
