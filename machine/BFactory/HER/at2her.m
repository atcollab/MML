function [Value, B] = at2her(Family, Field, k, DeviceList, Energy, BranchFlag)
%AT2HER - Converts simulator values to control system values
%  [Value, B] = at2her(Family, Field, K, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%    error('at2her conversion needs to be programmed for %s.%s\n', Family, Field);
