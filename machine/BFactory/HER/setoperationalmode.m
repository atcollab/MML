...
AD.SubMachine = 'HER';       % Will already be defined if setpathmml was used
AD.OperationalMode = '';     % Gets filled in later
AD.Energy = 8.9732;  % make sure this is the same as bend2gev at the production lattice!
AD.InjectionEnergy = 8.9732;
...
if ModeNumber == 1
    % User mode - High Tune
    AD.OperationalMode = 'HER 8.9732 GeV Model';
    ModeName = 'Model';
    OpsFileExtension = '_Model';

    % AT lattice
    AD.ATModel = 'her_at.mat';
    load her_at;
...
setad(AD);
MLROOT = setmmldirectories(AD.Machine, AD.SubMachine, ModeName, OpsFileExtension);
AD = getad;
