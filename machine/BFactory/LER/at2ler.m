function [Value, B] = at2ler(Family, Field, k, DeviceList, Energy, BranchFlag)
%AT2LER - Converts simulator values to control system values
%  [Value, B] = at2ler(Family, Field, K, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%    error('at2ler conversion needs to be programmed for %s.%s\n', Family, Field);
