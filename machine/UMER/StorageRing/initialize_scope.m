...
scope.channelObj1 = scope.deviceObj.Channel(1); % read from channel 1
scope.channelObj2 = scope.deviceObj.Channel(2); % read from channel 2
scope.channelObj3 = scope.deviceObj.Channel(3); % read from channel 3
scope.channelObj4 = scope.deviceObj.Channel(4); % read from channel 4

scope.waveformObj1 = scope.deviceObj.Waveform(1);  % default waveform measurement 1
scope.waveformObj2 = scope.deviceObj.Waveform(1);  % default waveform measurement 2
scope.waveformObj3 = scope.deviceObj.Waveform(1);  % default  waveform measurement 3
scope.waveformObj4 = scope.deviceObj.Waveform(1);  % default  waveform measurement 4
