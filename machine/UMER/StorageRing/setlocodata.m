...
switch CommandInput
    ...
    case 'Symmetrize'
        ...
        QFAscale = FitParameters(1).Values(17) ./ FitParameters(le).Values(17);
    ...
    case 'CorrectCoupling'
        ...
        CSQ0  = getsp('CSQ');
        CSQ   = FitParameters(1).Values(18:21);
        CSQhw = physics2hw('CSQ', 'Setpoint', CSQ);
