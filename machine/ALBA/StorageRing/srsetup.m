...
a = figure('Color',[0.8 0.8 0.8], ...
    ...
    'MenuBar','none', ...
    'Name', 'Ring Command Launcher ALBA', ...
    'NumberTitle','off', ...
    'Units','pixels', ...
...
set(b1(2), 'Callback','refreshthering', 'String','Lattice reload');
set(b1(3), 'Callback','plotfamily', 'String','Plotfamily');
set(b1(4), 'Callback','disp([''   Fichiers de Consignes;'']); configgui;;', 'String','Setpoint files');
%set(b1(5), 'Callback','disp([''   Ringcycling;'']);Ringcycling', 'String','Cyclage');
%set(b1(6), 'Callback','disp([''   Timing;'']); synchro_injecteur7;', 'String','Synchronisation définitive');
...
%et(b4(4), 'Callback','quadcell13(''Reset'')', 'String','RESET');
