...
GLOBVAL.E0 = 3e9;
GLOBVAL.LatticeFile = 'a-24';
FAMLIST = cell(0);

disp('   Loading ALBA lattice in a25_Symplectic. Version 0.9');
...
mf3=5.937840/0.22;
mf4=3.05743/0.15;
SD1    = sextupole('SD1' ,0.15/2, md1 ,'StrMPoleSymplectic4Pass');
SD2    = sextupole('SD2' ,0.15/2, md2 ,'StrMPoleSymplectic4Pass');
SD3    = sextupole('SD3' ,0.15/2, md3 ,'StrMPoleSymplectic4Pass');
SD4    = sextupole('SD4' ,0.22/2, md4 ,'StrMPoleSymplectic4Pass');
SD5    = sextupole('SD5' ,0.15/2, md5 ,'StrMPoleSymplectic4Pass');
SF1    = sextupole('SF1' ,0.15/2, mf1 ,'StrMPoleSymplectic4Pass');
SF2    = sextupole('SF2' ,0.22/2, mf2 ,'StrMPoleSymplectic4Pass');
SF3    = sextupole('SF3' ,0.22/2, mf3 ,'StrMPoleSymplectic4Pass');
SF4    = sextupole('SF4' ,0.15/2, mf4 ,'StrMPoleSymplectic4Pass');
...
BLOCK2  = [D21 cSD2 BPM D22 QF3 D23 QF4 D24 cSF2 BPM D25 QF5 D26 BPM cSD3 D28];
BLOCK31 = [D31 cSD4 BPM D32 QF6 D33 cSF3 D34 QD2 BPM M_ID];
BLOCK32 = [M_ID BPM QD3 D34 cSF3 D33 QF7 BPM D32 cSD4 D31];
BLOCK4  = [D41 cSD5 BPM D42 QF8 D43 BPM cSF4 S_ID];
