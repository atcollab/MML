...
try
    ...
    AO.QF6.Position = findspos(THERING, AO.QF6.AT.ATIndex(:,1))';
catch
...
try
    ...
    AO.QF7.Position = findspos(THERING, AO.QF7.AT.ATIndex(:,1))';
catch
...
try
    ...
    AO.QF8.Position = findspos(THERING, AO.QF8.AT.ATIndex(:,1))';
catch
