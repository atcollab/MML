function spsinfo
%SPSINFO - Prints hypertext for useful websites and commands to the command window
%
...
fprintf('\n   Useful Websites\n');
fprintf('   <a href="http://www.nsrc.or.th/th/">NSRC Homepage</a>             ');
fprintf('   <a href="http://lightsources.org/cms/">LightSources.Org</a>         \n');

fprintf('\n   Useful Commands\n');
fprintf('   <a href="matlab: setpathmml;">setpathmml</a> - Sets the Matlab path for an accelerator (like <a href="matlab: setpathsps;">SPS</a> or <a href="matlab: setpathals;">ALS</a>)\n');
