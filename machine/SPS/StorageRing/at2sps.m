function [Value, B] = at2sps(Family, Field, k, DeviceList, Energy, BranchFlag)
%AT2SPS - Converts the AT simulator values to control system values
%  [Value, B] = at2sps(Family, Field, K, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%
%  See also sps2at, hw2physics, physics2hw
%
