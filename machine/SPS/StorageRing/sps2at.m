function [k, B] = sps2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%SPS2AT - Converts control system values to the AT simulator values
%  [K, B] = sps2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%
%  See also at2sps, hw2physics, physics2hw
%
