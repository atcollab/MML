...
elseif strcmpi(Family,'IDsHCM') && strcmpi(Field,'Monitor')
    ChanName = [
        '\\192.168.100.25\Automatic_Polarity_Changer\S_MPW_STH_U '
        '\\192.168.100.25\Automatic_Polarity_Changer\S_MPW_STH_D '
        '\\192.168.100.25\Automatic_Polarity_Changer\S_SWLS_STH_U'
        '\\192.168.100.25\Automatic_Polarity_Changer\S_SWLS_STH_D'];
...
elseif strcmpi(Family,'IDsVCM') && strcmpi(Field,'Monitor')
    ChanName = [
        '\\192.168.100.25\Automatic_Polarity_Changer\S_MPW_STV_U '
        '\\192.168.100.25\Automatic_Polarity_Changer\S_MPW_STV_D '
        '\\192.168.100.25\Automatic_Polarity_Changer\S_SWLS_STV_U'
        '\\192.168.100.25\Automatic_Polarity_Changer\S_SWLS_STV_D'];
...
elseif strcmpi(Family,'IDsCC') && strcmpi(Field,'Monitor')
    ChanName = [
        '[U60-DCS]CC1_Current_Output'
        '[U60-DCS]CC2_Current_Output'
        '[U60-DCS]CC3_Current_Output'
        '[U60-DCS]CC4_Current_Output']; 
    
elseif strcmpi(Family,'IDsCC') && strcmpi(Field,'Setpoint')
    ChanName = [
        '[U60-DCS]CC1_Current_input'
        '[U60-DCS]CC2_Current_input'
        '[U60-DCS]CC3_Current_input'
        '[U60-DCS]CC4_Current_input'];   
