...
ModeCell = {'Fit Quadrupoles by Power Supply','Fit Quadrupoles by Magnet','Fit Quadrupoles by Magnet and Fit Quadrupole tilt','Fit Quadrupole by Magnet and Fit Bending magnet tilt','Fit Quadrupole by new power supply','No Parameter Setup'};
...
switch ButtonName
    case 1 %'Fit by Power Supply'
        ...
        fprintf('\n   Quadrupole Parameter Fits (strength) by Power Supply (4 Parameters)\n');
    ...
    case 5
       fprintf('\n   Quadrupole Parameter Fits(strength) by new power supply (28 Parameters)\n');
