...
% %Kicker
D11kick2  = drift('DRFC', 0.053, 'DriftPass');
D12kick2  = drift('DRFC', 0.1, 'DriftPass');  % maker of kicker
D2kick2  = drift('DRFC', 0.2610000, 'DriftPass'); 

D11kick3  = drift('D1kick3' ,0.5955,'DriftPass');
D12kick3  = drift('D1kick3' ,0.1,'DriftPass');
D2kick3  = drift('D2kick3' ,0.41,'DriftPass');

D11kick1  = drift('D1kick1',0.421, 'DriftPass');
D12kick1  = drift('D1kick1',0.1, 'DriftPass');
D2kick1  = drift('D1kick1',0.5845, 'DriftPass');
...
%Injection lattice
 QF1_K = 2.45699 % 2.47444;  
 QD2_K = -2.62369 %-2.62991; %
 QF3_K =  2.31755;
 QD4_K = -1.68214;
...
%  Kicker
% KICKER2 , AT = 0.153;
% KICKER3 , AT =10.748907+0.6955; 
% KICKER1 , AT = 69.344849+0.521; 

KICKER1 =  corrector('KICKER1',0.0,[0 0],'CorrectorPass');
KICKER2 =  corrector('KICKER2',0.0,[0 0],'CorrectorPass');
KICKER3 =  corrector('KICKER3',0.0,[0 0],'CorrectorPass');

% maker of kicker
mkick=  marker('mkick','IdentityPass'); % length is 0.1 mm

% Begin Lattice

SPERIOD1 =  [ D11kick2 mkick D12kick2 KICKER2 D2kick2 BPM D01md BPM D02m CORH1 D02 BPM D03 QF11 D04 CORV1 D05 QD21 D06 B01 B01 B01 B01 B01 B01 B01 B01 B01... 
            D07 BPM D08 QF31 D09 SF D10 CORH2 D11 BPM D12 SD D13 QD41 D14 SD...
            D15 CORV2 D11kick3 mkick D12kick3 KICKER3 D2kick3 CORH3 D17 SF D18 QF32 D19 BPM D20 B02 B02 B02 B02 B02 B02 B02 B02 B02...
...
SPERIOD3 =  [ D01 CORH9 D02 BPM D03 QF11 D04 CORV7 D05 QD21 D06 B01 B01 B01 B01 B01 B01 B01 B01 B01... 
            ...
            D21 QD22 D22 CORV9 D23 QF12 D24 BPM D25 CORH12 D26s BPM D01s ];  
            
SPERIOD4 =  [ D01s BPM D02s CORH13 D02 BPM D03 QF11 D04 CORV10 D05 QD21 D06 B01 B01 B01 B01 B01 B01 B01 B01 B01... 
            D07 BPM D08 QF31 D09 SF D10 CORH14 D11kick1 mkick D12kick1 KICKER1 D2kick1 CORV11 D2X SD D13 QD41 D14 SD...
