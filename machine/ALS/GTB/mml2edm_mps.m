...
BG = 64;  % LTB=, BR=, BTS=62, SR=4  (Note: TextControl BG=0)
...
[x12, y12]= mml2edm('BEND', ...
    ...
    'ChannelLabelWidth', ChannelLabelWidth, ...
    'TableTitle', 'Bends', ...
    'Fields',      {'Setpoint','Monitor', 'Shunt',   'SP-AM',   'Ready',           'On',              'OnControl'}, ...
    'TitleBar', TitleBar);
    %'ChannelType', {'Control', 'Monitor', 'Monitor', 'Monitor', 'Boolean Monitor', 'Boolean Monitor', 'Boolean Control'}, ...
  % 'Fields',      {'Setpoint','Monitor', 'Shunt',   'HallProbe', 'Ready',           'On',              'OnControl'}, ...
  % 'ChannelType', {'Control', 'Monitor', 'Monitor', 'Monitor',   'Boolean Monitor', 'Boolean Monitor', 'Boolean Control'}, ...

y12 = y12-15;
WriteEDMFile(FileName, EDMStaticText('BS Magnet Control Going to LTB?', x11+25, y12, 'HorizontalAlignment', 'Left', 'Width', 245));
WriteEDMFile(FileName, EDMTextMonitor('LTB_____BS_LTB_BC23', x11+25+250, y12, 'Width', 30, 'HorizontalAlignment', 'Left'));
y12 = y12+20;
WriteEDMFile(FileName, EDMStaticText('BS Magnet Control Going to FC?', x11+25, y12, 'HorizontalAlignment', 'Left', 'Width', 245));
WriteEDMFile(FileName, EDMTextMonitor('LTB_____BS_FC__BC22', x11+25+250, y12, 'Width', 30, 'HorizontalAlignment', 'Left'));
y12 = y12+30;
...
[x32, y32]= mml2edm('Q', ...
    ...
    'TitleBar', TitleBar);
    %'Fields', {'Setpoint','Monitor','Voltage','RegulatorTemp','ShuntTemp','SP-AM','Ready','On','OnControl'}, ...
