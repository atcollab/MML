function ErrorFlag = setgtb(Family, Field, NewSP, DeviceList, WaitFlag) 
%SETLTB - Ramps the GTB magnets in steps to avoid overshoots and trips
%  ErrorFlag = setgtb(Family, Field, NewSP, DeviceList, MaxStep, WaitFlag)
