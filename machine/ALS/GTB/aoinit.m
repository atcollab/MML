...
if isdeployed
    ...
    %    Note: Operational mode is being hardcoded with this method!!!  Best to move the default mode setup to this file (presently in gtbinit)
    %if ispc
    %    loadmml('n:\machine\ALS\GTBOpsData\50MEV\GoldenMMLSetup.mat');
    %else
    %    loadmml('/home/als/physbase/machine/ALS/GTBOpsData/50MEV/GoldenMMLSetup.mat');
    %end
