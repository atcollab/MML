...
%
%  CaenStruct = checkcaen(AccereleratorSection, DeviceName)
%             or
%  CaenStruct = checkcaen(CaenStruct)
%
%  INPUTS
%  1. AccereleratorSection
%     checkcaen('GTB')
%     checkcaen('BTS')
%     checkcaen('SR')
%     checkcaen('SR60')
...
for i = length(varargin):-1:1
    ...
    elseif strcmpi(varargin{i}, 'Numeric')
        %OutputStruct = 0;
        varargin(i) = [];
    elseif any(strcmpi(varargin{i}, {'GTB'}))
        Section = 'GTB';
        varargin(i) = [];
    elseif any(strcmpi(varargin{i}, {'BTS'}))
        Section = 'BTS';
        varargin(i) = [];
    elseif any(strcmpi(varargin{i}, {'SR'}))
        Section = 'SR';
        varargin(i) = [];
    elseif any(strcmpi(varargin{i}, {'SR60'}))
        Section = 'SR60';
        varargin(i) = [];
...
if strcmpi(DisplayFlag, 'On') || strcmpi(DisplayFlag, 'OnForChanges')
    fprintf('   Checking %d Caen power supplies for the proper setup (%s)\n', length(Caen), Section);
end
...
if strcmpi(DisplayFlag, 'On') || strcmpi(DisplayFlag, 'OnForChanges')
    fprintf('   Caen power supplies parameter check complete.\n');
end
