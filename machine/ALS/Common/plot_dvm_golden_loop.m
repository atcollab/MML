...
while 1
    ...
    if ~SkipFlag
        ...
        if 1
            figure(12);
            subplot(2,2,1);
            plot((1:endind)*NewData.TimeStep,125*10/10*NewData.Data(1:endind,1),'g',(1:endindold)*GoldData.TimeStep,125*10/10*GoldData.Data(1:endindold,1),'k')
            hold on;
            ...
            if (NewData.TimeStep == GoldData.TimeStep)
                plot((1:endind)*NewData.TimeStep,(125*10/10*NewData.Data(1:endind,1)-125*10/10*GoldData.Data(1:endind,1))./(125*10/10*GoldData.Data(1:endind,1)),'k');
            else
                plot((1:endind)*NewData.TimeStep,(125*10/10*NewData.Data(1:endind,1)'-interp1((1:endindold)*GoldData.TimeStep,125*10/10*GoldData.Data(1:endindold,1),(1:endind)*NewData.TimeStep,'linear','extrap'))./interp1((1:endindold)*GoldData.TimeStep,125*10/10*GoldData.Data(1:endindold,1),(1:endind)*NewData.TimeStep,'linear','extrap'),'k');
            end
            hold on
