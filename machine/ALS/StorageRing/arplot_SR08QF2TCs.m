function arplot_SR08QF2TCs(monthStr, days, year1, month2Str, days2, year2)
%ARPLOT_SR08QF2TCs - Plots SR06_QF2 coil temperature data from the ALS archiver
%  arplot_SR08QF2TCs(Month1 String, Days1, Year1, Month2 String, Days2, Year2)
%
%  EXAMPLE
%  arplot_SR08QF2TCs('September',1:19,2008);
%


uiwait(warndlg('WARNING: The TC mappings given in the legend are only valid AFTER 19:30 on 3-30-10!','arplot_SR08QF2TCs WARNING'));
...
for day = days
    ...
    SR08TCWAGOAM05 = [SR08TCWAGOAM05 arselect('SR08W___TCWAGO_AM05')];
    SR08TCWAGOAM03 = [SR08TCWAGOAM03 arselect('SR08W___TCWAGO_AM03')];
...
SR08TCWAGOAM05 = (SR08TCWAGOAM05*9/5) + 32;
SR08TCWAGOAM03 = (SR08TCWAGOAM03*9/5) + 32;
...
%h = subplot(2,1,1);
subplot(3,1,1)
plot(t, [SR08TCWAGOAM05; SR08TCWAGOAM03]);
xaxis([0 MaxTime]);
yaxis([60 180]);
grid on;
title(['SR08C QF2 Coil Temps: ',titleStr]);
text(1,1,'WARNING: The TC mappings given in the legend are only valid AFTER 19:30 on 3-30-10!');
ChangeAxesLabel(t, Days, DayFlag);
ylabel('Temp [DegF]');
h=legend('SR08C QF2 Upper/Outer Coil', 'SR08C QF2 Lower/Outer Coil');
