...
iRemove = findrowindex([Sector-1 10; Sector-1 11; Sector-1 12; Sector 1], BPMxList);
BPMxList(iRemove,:) = [];

iRemove = findrowindex([Sector-1 10; Sector-1 11; Sector-1 12; Sector 1], BPMyList);
BPMyList(iRemove,:) = [];
