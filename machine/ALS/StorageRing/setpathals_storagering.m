function [MachineName, SubMachineName, LinkFlag, MMLROOT] = setpathals_storagering(varargin)
%SETPATHALS_STORAGERING - Initializes the Matlab Middle Layer (MML) for ALS Storage Ring
%  [MachineName, SubMachineName, OnlineLinkMethod, MMLROOT] = setpathals_storagering(OnlineLinkMethod)
%
%  INPUTS
%  1. OnlineLinkMethod - 'MCA', 'LabCA', 'SCA'
% 
%  NOTES
%  1. To initialize the storage ring with a clean path:
...
pathstr = fileparts(which('setpathals_storagering.m'));
