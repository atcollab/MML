function arplot_sr_transferbpm(monthStr, days, year1, month2Str, days2, year2)
...
aa(3) = 30;
aa(4) = 75;
set(ax(1),'YTick',[30:10:70]');
set(ax(2),'YTick',[30:10:70]');
axis(aa);
axes(ax(2));
aa = axis;
aa(1) = 0;
...
%aa = axis;
aa = [0 xmax 10 40];
set(ax(1),'YTick',[15:5:45]');
set(ax(2),'YTick',[10:5:40]');
axis(aa);
if DayFlag
    MaxDay = round(max(t));
    set(ax(1),'XTick',[0:MaxDay]');
...
subplot(4,1,2);
plot(t, ConductSup, t, ConductRet);
grid on;
ylabel('Conductivity');
axis tight
axisvals = axis;
...
elseif datenum(year1, month, days(1)) < 735488 % sensor was recalibrated from MOhm/cm to microS/cm on 2013-09-11
    ...
    legend('Supply [\muS/cm]','Return [\muS/cm]','Location','Best');
end
