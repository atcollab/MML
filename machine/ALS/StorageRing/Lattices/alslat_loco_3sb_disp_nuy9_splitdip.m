function varargout = als_loco_3sb_disp_nuy9_splitdip(varargin)
...
%% Marker and apertures
   ...
   BLdot0 =  marker('BLdot0', 'IdentityPass');
   BLdot1 =  marker('BLdot1', 'IdentityPass');
   BLdot2 =  marker('BLdot2', 'IdentityPass');
   BLdot3 =  marker('BLdot3', 'IdentityPass');
   BLdot4 =  marker('BLdot4', 'IdentityPass');
   BLSBdot2 =  marker('BLSBdot2', 'IdentityPass');
   BLSBdot3 =  marker('BLSBdot3', 'IdentityPass');
...
BEND	=	rbend('BEND'  , 0.86514,  ...
            0.1745329, 0.0872664, 0.0872664, -0.7782,'BndMPoleSymplectic4RadPass');
B1a 	=	rbend('B1a'  , 6.3/10*0.86514,  ...
            6.3/10*0.1745329, 0.0872664, 0.0, -0.7782,'BndMPoleSymplectic4RadPass');
B1b 	=	rbend('B1b'  , 3.7/10*0.86514,  ...
            3.7/10*0.1745329, 0.0, 0.0872664, -0.7782,'BndMPoleSymplectic4RadPass');
B2a 	=	rbend('B2a'  , 2.6/10*0.86514,  ...
            2.6/10*0.1745329, 0.0872664, 0.0, -0.7782,'BndMPoleSymplectic4RadPass');
B2b 	=	rbend('B2b'  , 4.8/10*0.86514,  ...
            4.8/10*0.1745329, 0.0, 0.0, -0.7782,'BndMPoleSymplectic4RadPass');
B2c 	=	rbend('B2c'  , 2.6/10*0.86514,  ...
            2.6/10*0.1745329, 0.0, 0.0872664, -0.7782,'BndMPoleSymplectic4RadPass');
B3a 	=	rbend('B3a'  , 2.6/10*0.86514,  ...
            2.6/10*0.1745329, 0.0872664, 0.0, -0.7782,'BndMPoleSymplectic4RadPass');
B3b 	=	rbend('B3b'  , 7.4/10*0.86514,  ...
            7.4/10*0.1745329, 0.0, 0.0872664, -0.7782,'BndMPoleSymplectic4RadPass');
...
BSa    =  rbend('BSa', 2.6/10*0.255, ...
            2.6/10*0.1745329, 0.0872665, 0.0, 0,'BndMPoleSymplectic4RadPass');
BSb    =  rbend('BSb', 4.8/10*0.255, ...
            4.8/10*0.1745329, 0.0, 0.0, 0,'BndMPoleSymplectic4RadPass');
BSc    =  rbend('BSc', 2.6/10*0.255, ...
            2.6/10*0.1745329, 0.0, 0.0872665, 0,'BndMPoleSymplectic4RadPass');
...
SUP  = [   BLdot0 L1 COR L2 BPM L3 QF L4 COR L5 QD  ...
           L6 BPM L7 L8 B1a BLdot1 B1b L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 B2a BLdot2 B2b BLdot3 B2c L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 B3a BLdot4 B3b L21 ... 
           BPM L22 QD L23 COR L24 QF L25  ...
           BPM L26  COR L27 ];
SUP1  = [  BLdot0 L1 L2 BPM L3 QF L4 COR L5 QD  ...
           L6 BPM L7 L8 B1a BLdot1 B1b L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 B2a BLdot2 B2b BLdot3 B2c L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 B3a BLdot4 B3b L21 ... 
           BPM L22 QD L23 COR L24 QF L25  ...
           BPM L26  COR L27 ];
SUPS  = [ BLdot0  L1 COR L2 BPM L3 QF L4 COR L5 QD  ...
           L6 BPM L7 L8 B1a BLdot1 B1b L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF LS1 QDA LS2 BPM  ...
           LS3 BSa BLSBdot2 BSb BLSBdot3 BSc LS3 BPM LS2 QDA LS1  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 B3a BLdot4 B3b L21 ... 
           BPM L22 QD L23 COR L24 QF L25  ...
           BPM L26 COR L27 ];
SUP12S  = [ BLdot0  L1 COR L2 BPM L3 QF L4 COR L5 QD  ...
           L6 BPM L7 L8 B1a BLdot1 B1b L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF LS1 QDA LS2 BPM  ...
           LS3 BSa BLSBdot2 BSb BLSBdot3 BSc LS3 BPM LS2 QDA LS1  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 B3a BLdot4 B3b L21 ... 
