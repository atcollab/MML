function varargout = als_loco_3sb_disp_epuskews3(varargin)
...
GLOBVAL.E0 = 1.9e9;
GLOBVAL.LatticeFile = 'als_loco_3sb_disp_epuskews3';
FAMLIST = cell(0);
disp(' ');
disp('** Loading ALS lattice in alslat_loco_3sb_disp_epuskews3.m **');
...
EPUSKEW4 = quadrupole('EPUSKEW4' , 2.832696-0.8596-0.1524-0.1,  0.0 , 'StrMPoleSymplectic4RadPass');
EPUSKEW4U = quadrupole('EPUSKEW4U' , 0.05,  0.0 , 'StrMPoleSymplectic4RadPass');
EPUSKEW4D = quadrupole('EPUSKEW4D' , 0.05,  0.0 , 'StrMPoleSymplectic4RadPass');
EPUSKEW11 = quadrupole('EPUSKEW11' , 2.832695-0.8596-0.1524-0.1,  0.0 , 'StrMPoleSymplectic4RadPass');
EPUSKEW11U = quadrupole('EPUSKEW11U' , 0.05,  0.0 , 'StrMPoleSymplectic4RadPass');
EPUSKEW11D = quadrupole('EPUSKEW11D' , 0.05,  0.0 , 'StrMPoleSymplectic4RadPass');
...
SHF   =  sextupole('SHF', 0.2030/2,  0.0, 'StrMPoleSymplectic4RadPass');
SHD   =  sextupole('SHD', 0.2030/2,  0.0, 'StrMPoleSymplectic4RadPass');
...
SUP  = [   L1 COR L2 BPM L3 QF L4a SHD COR SHD L5a QD  ...
           ...
           BPM L22 QD L23a SHD COR SHD L24a QF L25  ...
           BPM L26  COR L27 ];
SUP1  = [   L1 L2 BPM L3 QF L4a SHD COR SHD L5a QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
           BPM L22 QD L23a SHD COR SHD L24a QF L25  ...
           BPM L26  COR L27 ];
SUPS  = [   L1 COR L2 BPM L3 QF L4a SHD COR SHD L5a QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           ...
           BPM L22 QD L23a SHD COR SHD L24a QF L25  ...
           BPM L26 COR L27 ];
SUPEPU4  = [   L1 COR L2 BPM L3 QF L4a SHD COR SHD L5a QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
           BPM L22 QD L23a SHD COR SHD L24a QF L25  ...
           BPM L26  COR L27a EPUSKEW4U EPUSKEW4 EPUSKEW4D L27b ];
SUPEPU11  = [   L1a EPUSKEW11U EPUSKEW11 EPUSKEW11D L1b COR L2 BPM L3 QF L4a SHD COR SHD L5a QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
...
SUP12S  = [   L1 COR L2 BPM L3 QF L4a SHD COR SHD L5a QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF LS1 QDA LS2 BPM  ...
           LS3 BS LS3 BPM LS2 QDA LS1  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
