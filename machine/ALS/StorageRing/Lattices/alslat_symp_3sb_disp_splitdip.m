function alslat_symp_3sb_disp_splitdipole
...
GLOBVAL.E0 = 1.9e9;
GLOBVAL.LatticeFile = 'als_symp_3sb_disp_splitdipole';
FAMLIST = cell(0);
disp(' ');
disp('** Loading ALS lattice in alslat_symp_3sb_disp_splitdip.m **');
...
%   LS1 = drift('LS1', 0.223268, 'DriftPass');
   ...
   LS4 = drift('LS4', 0.484826, 'DriftPass');
   LS5 = drift('LS5', 0.094844, 'DriftPass');
...
SUPS  = [   L1 L2 BPM L3 QF L4 L5 QD  ...
           ...
           LS3 BSa BSb BSc LS4 BPM LS5 QDA LS1  SF  L17  ...
           QFA L18 BPM L19  SD L20 B3a B3b L21 ... 
           BPM L22 QD L23  L24 QF L25  ...
           BPM L26  L27 ];
