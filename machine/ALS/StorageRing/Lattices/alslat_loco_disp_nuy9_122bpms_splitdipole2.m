...
QF    =  quadrupole('QF'  , 0.344,  2.236000, 'StrMPoleSymplectic4RadPass');
QD    =  quadrupole('QD'  , 0.187, -2.500700, 'StrMPoleSymplectic4RadPass');
...
B1a  = rbend('BEND', 0.86514/2, 0.1745329/2, 0.0872664, 0.0,       -0.7782,'BndMPoleSymplectic4RadPass');
B1b  = rbend('BEND', 0.86514/2, 0.1745329/2, 0.0,       0.0872664, -0.7782,'BndMPoleSymplectic4RadPass');
B2a  = rbend('BEND', 0.86514/2, 0.1745329/2, 0.0872664, 0.0,       -0.7782,'BndMPoleSymplectic4RadPass');
B2b  = rbend('BEND', 0.86514/2, 0.1745329/2, 0.0,       0.0872664, -0.7782,'BndMPoleSymplectic4RadPass');
B3a  = rbend('BEND', 0.86514/2, 0.1745329/2, 0.0872664, 0.0,       -0.7782,'BndMPoleSymplectic4RadPass');
B3b  = rbend('BEND', 0.86514/2, 0.1745329/2, 0.0,       0.0872664, -0.7782,'BndMPoleSymplectic4RadPass');
...
SUP1  = [  L1 L2 BPM L3 QF L4 COR L5 QD  ...
    ...
    L14 B2a B2b L15 BPM L16  SFF COR SFF  L17  ...
