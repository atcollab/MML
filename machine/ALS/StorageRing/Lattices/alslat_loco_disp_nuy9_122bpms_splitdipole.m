...
fprintf('   Loading ALS lattice in file %s\n', mfilename);


%L0 = 196.8054150;  % design length with superbends [m]
L0 = 196.8000096;	% design length without superbends [m]
...
HarmNumber = 328;
V = version;
if str2num(V(1,1)) < 7 & strncmp(computer, 'GLNX', 4)
    % Older AT version
...
L1e2u  = drift('L1e2u',      2.5982-1, 'DriftPass');       %L1e2  = drift('L1e2',   2.5982-.000451, 'DriftPass');
L1e2d  = drift('L1e2d',      1       , 'DriftPass');       %L1e2  = drift('L1e2',   2.5982-.000451, 'DriftPass');
...
SUP1  = [  L1 L2 BPM L3 QF L4 COR L5 QD  ...
    L6 BPM L7 L8 B1a B1b L9 SDD COR SDD L10 ...
    BPM L11 QFA L12  SFF COR SFF L13 BBPM  ...
    L14 B2a B2b B2c L15 BBPM L16  SFF COR SFF  L17  ...
    QFA L18 BPM L19  SDD COR SDD L20 B3a B3b L21 ...
