function varargout = als_loco_3sb_disp_epuskews_epu42(varargin)
% Lattice definition file
% Compiled by Christoph Steier from the ALS TRACY 
% lattice file of Tom Scarvie for EPU4-2 skew analysis - 7-2009 
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% need to incorporate drifts and EPUSKEW markers into lattice above
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
SUPEPU4  = [   L1a EPUSKEW4U EPUSKEW4 EPUSKEW4D L1b COR L2 BPM L3 QF L4 COR L5 QD  ...
             L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
             BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
             L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
             QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
             BPM L22 QD L23 COR L24 QF L25  ...
             BPM L26  COR L27 ];
SUPEPU11  = [   L1 COR L2 BPM L3 QF L4 COR L5 QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
           BPM L22 QD L23 COR L24 QF L25  ...
           BPM L26  COR L27 ];
% SUPEPU11  = [   L1a EPUSKEW11U EPUSKEW11 EPUSKEW11D L1b COR L2 BPM L3 QF L4 COR L5 QD  ...
%            L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
%            BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
%            L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
%            QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
