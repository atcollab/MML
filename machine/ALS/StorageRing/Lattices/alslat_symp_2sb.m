...
GLOBVAL.E0 = 1.9e9;
GLOBVAL.LatticeFile = 'als_symp_2sb';
FAMLIST = cell(0);
disp(' ');
disp('** Loading ALS lattice in alslat_symp_2sb.m **');
...
THERING = setcellstruct(THERING,'K',QFI([7:8 15:16]),2.212276);
THERING = setcellstruct(THERING,'PolynomB',QFI([7:8 15:16]),2.212276,2);
QDI = findcells(THERING,'FamName','QD');
THERING = setcellstruct(THERING,'K',QDI([7:8 15:16]),-2.214324);
THERING = setcellstruct(THERING,'PolynomB',QDI([7:8 15:16]),-2.214324,2);
QFAI = findcells(THERING,'FamName','QFA');
THERING = setcellstruct(THERING,'K',QFAI([7:8 15:16]),3.059132);
THERING = setcellstruct(THERING,'PolynomB',QFAI([7:8 15:16]),3.059132,2);
