function alslat_loco_3sb_disp_nuy9_122bpms_epuskews(varargin)
...
EPUL = CM2CL-0.8596-0.1524
EPUSKEW = quadrupole('EPUSKEW' , EPUL,  0.0 , 'StrMPoleSymplectic4RadPass');
...
% COR L27s4a CHIC L27s4b IDBPM L27s4c EPUSKEW L1s4a IDBPM L1s4b CHIC COR L1s4c IDBPM L1s4da EPUSKEW L1s4d IDBPM L1s4e CHIC L1s4f COR
...
L27s4c = drift('L27s4c', ID4CL2IDBPM1-EPUL-0.1524,                  'DriftPass');
L1s4a  = drift('L1s4a',  ID4CL2IDBPM3+0.1524,                  'DriftPass');
L1s4b  = drift('L1s4b',  ID4CL2Chicane2-ID4CL2IDBPM3,   'DriftPass');
L1s4c  = drift('L1s4c',  ID4CL2IDBPM4-ID4CL2Chicane2,   'DriftPass'); 
L1s4da  = drift('L1s4da',  0.1524,     'DriftPass');
L1s4d  = drift('L1s4d',  ID4CL2IDBPM2-ID4CL2IDBPM4-EPUL-0.1524,     'DriftPass');
...
% Straight 6
% Note: base lattice is made without the chicanes on
% COR L27s6a CHIC L27s6b IDBPM L27s6c L1s6a IDBPM L1s6b CHIC COR L1s6c IDBPM L1s6da EPUSKEW L1s6d IDBPM L1s6e COR
...
L1s6da  = drift('L1s6da',  0.1524,     'DriftPass');
L1s6d  = drift('L1s6d',  ID6CL2IDBPM2-ID6CL2IDBPM4-EPUL-0.1524,     'DriftPass');
...
% Straight 11
% Note: base lattice is made without the chicanes on
% COR L27s11a IDBPM L27s11c EPUSKEW L27s11d L1s11a IDBPM L1s11b CHIC COR L1s11c IDBPM L1s11da EPUSKEW L1s11d IDBPM L1s11e  COR
...
L27s11c = drift('L27s11c', ID11CL2IDBPM1-EPUL-0.1524,                 'DriftPass');
L27s11d = drift('L27s11d', 0.1524,                 'DriftPass');
...
L1s11da  = drift('L1s11d',  0.1524,   'DriftPass');
L1s11d  = drift('L1s11d',  ID11CL2IDBPM2-ID11CL2IDBPM4-EPUL-0.1524,   'DriftPass');
...
SUP3  = [  L1 COR L2 BPM L3 QF L4 COR L5 QD  ...
    ...
    QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ...
    BPM L22 QD L23 COR L24 QF L25  ...
    BPM L26 COR L27s4a CHIC L27s4b IDBPM L27s4c EPUSKEW ];
SUP4  = [L1s4a IDBPM L1s4b CHIC COR L1s4c IDBPM L1s4da EPUSKEW L1s4d IDBPM L1s4e CHIC L1s4f COR L2 BPM L3 QF L4 COR L5 QD  ...
    L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ...
...
SUP6  = [L1s6a IDBPM L1s6b CHIC COR L1s6c IDBPM L1s6da EPUSKEW L1s6d IDBPM L1s6e COR L2 BPM L3 QF L4 COR L5 QD  ...
    L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ...
    BPM L11 QFA L12  SFF COR SFF L13 BBPM  ...
    L14 BEND L15 BBPM L16  SFF COR SFF  L17  ...
    QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ...
...
SUP10 = [  L1e10 IDBPM L1f10 COR L2 BPM L3 QF L4 COR L5 QD  ...
    ...
    QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ...
    BPM L22 QD L23 COR L24 QF L25  ...
    BPM L26 COR L27s11a  IDBPM L27s11c EPUSKEW L27s11d];
SUP11 = [L1s11a IDBPM L1s11b CHIC COR L1s11c IDBPM L1s11da EPUSKEW L1s11d IDBPM L1s11e COR L2 BPM L3 QF L4 COR L5 QD  ... 
    L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ...
    BPM L11 QFA L12  SFF COR SFF L13 BBPM  ...
    L14 BEND L15 BBPM L16  SFF COR SFF  L17  ...
    QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ...
