function alslat_symp_3sb_disp_3aper
...
GLOBVAL.E0 = 1.9e9;
GLOBVAL.LatticeFile = 'als_symp_3sb_disp_3aper';
FAMLIST = cell(0);
disp(' ');
disp('** Loading ALS lattice in alslat_symp_3sb_disp_3aper.m **');
...
%% Marker and apertures
   ...
   COL1 = aperture('COL1',[-0.03 0.03 -0.0025 0.0025],'IdentityPass');
   COL2 = aperture('COL2',[-0.03 0.03 -0.0025 0.0025],'IdentityPass');
   U281 = aperture('U281',[-0.03 0.03 -0.0025 0.0025],'IdentityPass');
   U282 = aperture('U282',[-0.03 0.03 -0.0025 0.0025],'IdentityPass');
   U283 = aperture('U283',[-0.03 0.03 -0.0025 0.0025],'IdentityPass');
...
ELIST = [INJ SECT1 SUP SECT2 SUP2 SECT3 CAV SUP3 SECT4 SUPS SECT5 SUP5 SECT6 SUP6 ...
