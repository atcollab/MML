function alslat_symp_3sb_disp_old
...
% eta_x  6cm. QFA magnets in one chain.

global FAMLIST THERING GLOBVAL
GLOBVAL.E0 = 1.9e9;
GLOBVAL.LatticeFile = 'als_symp_3sb_disp_old';
FAMLIST = cell(0);
disp(' ');
disp('** Loading ALS lattice in alslat_symp_3sb_disp_old.m **');
...
QF		=	quadrupole('QF'  , 0.344, 2.199275 ,'StrMPoleSymplectic4RadPass');
QD		=	quadrupole('QD'  , 0.187, -2.261085 ,'StrMPoleSymplectic4RadPass');
QFA		=	quadrupole('QFA'  , 0.448, 2.956009 ,'StrMPoleSymplectic4RadPass');
QDA		=	quadrupole('QDA'  , 0.2, -1.700825 ,'StrMPoleSymplectic4RadPass');
...
THERING = setcellstruct(THERING,'K',QFI([7:8 15:16 23:24]),2.179398);
THERING = setcellstruct(THERING,'PolynomB',QFI([7:8 15:16 23:24]),2.179398,2);
QDI = findcells(THERING,'FamName','QD');
THERING = setcellstruct(THERING,'K',QDI([7:8 15:16 23:24]),-2.221800);
THERING = setcellstruct(THERING,'PolynomB',QDI([7:8 15:16 23:24]),-2.221800,2);
QFAI = findcells(THERING,'FamName','QFA');
THERING = setcellstruct(THERING,'K',QFAI([7:8 15:16 23:24]),3.127981);
THERING = setcellstruct(THERING,'PolynomB',QFAI([7:8 15:16 23:24]),3.127981,2);
