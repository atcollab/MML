function alslat_loco_3sb_disp_nux16_122bpms_longmisaligned(varargin)
...
L1a1 = drift('L1a',  CM2CL-0.2030/2+5.5*0.0254, 'DriftPass');
...
L2a1 = drift('L2a',  0.45698-0.2030/2-5.5*0.0254, 'DriftPass');
...
%  Superperiods
SUP1  = [  L1a1 SHFF SHFF L2a1 BPM L3 QF L4a SHDD COR SHDD L5a QD  ...
...
THERING = setcellstruct(THERING,'K',QFI([7:8 15:16 23:24]),2.317548);
THERING = setcellstruct(THERING,'PolynomB',QFI([7:8 15:16 23:24]),2.317548,2);
QDI = findcells(THERING,'FamName','QD');
THERING = setcellstruct(THERING,'K',QDI([7:8 15:16 23:24]),-2.577416);
THERING = setcellstruct(THERING,'PolynomB',QDI([7:8 15:16 23:24]),-2.577416,2);
QFAI = findcells(THERING,'FamName','QFA');
THERING = setcellstruct(THERING,'K',QFAI([7:8 15:16 23:24]),3.276137);
THERING = setcellstruct(THERING,'PolynomB',QFAI([7:8 15:16 23:24]),3.276137,2);
