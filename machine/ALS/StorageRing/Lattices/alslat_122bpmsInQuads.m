function varargout = alslat_loco_3sb_disp_nuy9_122bpms(varargin)
...
GLOBVAL.LatticeFile = 'alslat_loco_3sb_disp_nuy9_122bpms';
FAMLIST = cell(0);

fprintf('   Loading ALS lattice in %s\n', mfilename);


% I'm not sure why I need this line here
...
SUP7  = [  L1e7 IDBPM L1f7 COR L2 L3 BPM QF L4 COR L5 QD  ...
    L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ...
    BPM L11 QFA L12  SFF COR SFF L13 BBPM  ...
    L14 BEND L15 BBPM L16  SFF COR SFF  L17  ...
    QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ...
