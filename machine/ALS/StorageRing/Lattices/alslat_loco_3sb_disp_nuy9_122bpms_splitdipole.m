...
BSa =  rbend('BS', 2.6/10*0.255, 2.6/10*0.1745329, 0.0872665, 0.0,       0,'BndMPoleSymplectic4RadPass');
BSb =  rbend('BS', 4.8/10*0.255, 4.8/10*0.1745329, 0.0,       0.0,       0,'BndMPoleSymplectic4RadPass');
BSc =  rbend('BS', 2.6/10*0.255, 2.6/10*0.1745329, 0.0,       0.0872665, 0,'BndMPoleSymplectic4RadPass');
...
% BSI = findcells(THERING,'FamName','BSa');
% THERING = setcellstruct(THERING,'PolynomB', BSI, -22.68, 3);
% BSI = findcells(THERING,'FamName','BSb');
% THERING = setcellstruct(THERING,'PolynomB', BSI, -22.68, 3);
% BSI = findcells(THERING,'FamName','BSc');
% THERING = setcellstruct(THERING,'PolynomB', BSI, -22.68, 3);
