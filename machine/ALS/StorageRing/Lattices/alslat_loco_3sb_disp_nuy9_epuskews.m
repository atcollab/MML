function varargout = als_loco_3sb_disp_epuskews2(varargin)
...
GLOBVAL.E0 = 1.9e9;
GLOBVAL.LatticeFile = 'als_loco_3sb_disp_nuy9_epuskews';
FAMLIST = cell(0);
disp(' ');
disp('** Loading ALS lattice in alslat_loco_3sb_disp_nuy9_epuskews.m **');
