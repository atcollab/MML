function alslat_symp_3sb_disp_epuskew
...
GLOBVAL.E0 = 1.9e9;
GLOBVAL.LatticeFile = 'als_symp_3sb_disp_epuskew';
FAMLIST = cell(0);
disp(' ');
disp('** Loading ALS lattice in alslat_symp_3sb_disp_epuskew.m **');
...
EPUSKEW = quadrupole('EPUSKEW' , 2.832696-0.8596-0.1524,  0.0 , 'StrMPoleSymplectic4RadPass');
...
ELIST = [INJ SECT1 SUP SECT2 SUP SECT3 CAV SUPEPU SECT4 SUPS SECT5 SUP SECT6 SUP ...
