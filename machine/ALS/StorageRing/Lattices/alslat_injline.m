function varargout = alslat_injline(varargin)
...
GLOBVAL.E0 = 1.522e9;
GLOBVAL.LatticeFile = 'alslat_injline';
FAMLIST = cell(0);
disp(' ');
disp('** Loading ALS lattice in alslat_injline.m **');
...
%% Marker and apertures
   ...
   INJ = aperture('INJ',[-0.015 0.03 -0.007 0.007],'AperturePass');
   S2 = aperture('INJ',[-0.03 0.03 -0.009 0.009],'AperturePass');
   S3 = aperture('INJ',[-0.03 0.03 -0.009 0.009],'AperturePass');
   S4 = aperture('INJ',[-0.03 0.03 -0.007 0.007],'AperturePass');
...
% DRIFT SPACES
   L1 = drift('L1',  2.832695, 'DriftPass');
   L1s1 = drift('L1s1',  2.306, 'DriftPass');
   L1s2 = drift('L1s2',  2.832695-2.306, 'DriftPass');
   L2 = drift('L2',  0.45698, 'DriftPass');
   L3 = drift('L3',  0.08902, 'DriftPass');
   L4 = drift('L4',  0.2155, 'DriftPass');
   L5 = drift('L5',  0.219, 'DriftPass');
   ...
   L26 = drift('L26',  0.45698, 'DriftPass');
   L27 = drift('L27',  2.832696, 'DriftPass');
   L27s1 = drift('L27',  2.832696-2.306, 'DriftPass');
   L27s2 = drift('L27',  2.306, 'DriftPass');
   L27a = drift('L27a',  0.8596, 'DriftPass');
   L27b = drift('L27b',  0.1524, 'DriftPass');
   L27c = drift('L27c',  0.04445, 'DriftPass');
   L27d = drift('L27d',  1.776246, 'DriftPass');
...
% end of BTS line
HCM8 = corrector('HCM8',0.0,[0 0],'CorrectorPass');
L43 = drift('L43', 0.25, 'DriftPass');
VCM8 = corrector('VCM8',0.0,[0 0],'CorrectorPass');
L44 = drift('L44', 1.385679, 'DriftPass');
BPM6 =  marker('BPM6','IdentityPass');
L45 = drift('L45', 0.955427, 'DriftPass');
HCM9 = corrector('HCM9',0.0,[0 0],'CorrectorPass');
L46 = drift('L46', 0.247279, 'DriftPass');
VCM9 = corrector('VCM9',0.0,[0 0],'CorrectorPass');
L47 = drift('L47', 0.392873, 'DriftPass');
TV6 =  marker('TV6','IdentityPass');
L48 = drift('L48', 0.807128, 'DriftPass');
SIK  =  rbend('SIK'  , 0.9,  ...
            0.17575465567583, 0.08787732783791, 0.08787732783791, ...
            0,'BndMPoleSymplectic4RadPass');
L49 = drift('L49', 0.277, 'DriftPass');
SIN  =  rbend('SIN'  , 0.6,  ...
            0.03490658503989, 0.01745329251994, 0.01745329251994, ...
            0,'BndMPoleSymplectic4RadPass');
L50 = drift('L50', 0.22743, 'DriftPass');
SRBMP3 = rbend('SRBMP3'  , 0.7,  ...
            -0.011, -0.0055, -0.0055, ...
            0,'BndMPoleSymplectic4RadPass');
L51 = drift('L51', 0.3, 'DriftPass');
SRBMP4 = rbend('SRBMP4'  , 0.7,  ...
            0.011, 0.0055, 0.0055, ...
            0,'BndMPoleSymplectic4RadPass');
L52 = drift('L52', 0.780022-0.344/2-0.08902, 'DriftPass');

% Begin Lattice

% BTS endsection

BTS = [HCM8 L43 VCM8 L44 BPM6 L45 HCM9 L46 VCM9 ...
L47 TV6 L48 SIK L49 SIN INJ SECT1 L50 SRBMP3 L51 SRBMP4 L52];
...
SUP1  = [   L1 L2 BPM L3 QF L4 COR L5 QD  ...
           ...
           BPM L22 QD L23 COR L24 QF L25  ...
           BPM L26  COR L27 ];
SUP2  = [   S2 L1 S2 COR L2 BPM L3 QF L4 COR L5 QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
           BPM L22 QD L23 COR L24 QF L25  ...
           BPM L26  COR S3 L27 ];
SUP3  = [   S3 L1 S3 COR L2 BPM L3 QF L4 COR L5 QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
           BPM L22 QD L23 COR L24 QF L25  ...
           BPM L26  COR L27s1 S4 L27s2 S4 L1s1 S4 L1s2 ...
           COR L2 BPM L3 QF L4 COR L5 QD L6 BPM L7];
SUP1BTS  = [INJ BPM L3 QF L4 COR L5 QD  ...
           L6 BPM L7 L8 BEND L9 SDD COR SDD L10 ... 
           BPM L11 QFA L12  SFF COR SFF L13 BPM  ...
           L14 BEND L15 BPM L16  SFF COR SFF  L17  ...
           QFA L18 BPM L19  SDD COR SDD L20 BEND L21 ... 
...
ILIST = [BTS SUP1BTS SECT2 SUP2 SECT3 CAV SUP3 SECT4];
