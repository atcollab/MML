...
% Wiggler W11/W16
if isunix
    load '/home/als/physdata/matlab/srdata/insertiondevices/wiggler/W11/wiggler_harmonics.mat'
else
    load '\\Als-filer\physdata\matlab\srdata\insertiondevices\wiggler\W11\wiggler_harmonics.mat'
end

% W11 = wiggler('W11',L_wig,4,6,0.2998/(GLOBVAL.E0/1.0e9)*B_matrix,lambdaz,zeros(4,1),kx,'WigSymplectic4Pass');
W11 = wiggler('W11',L_wig,4,1,0.2998/(GLOBVAL.E0/1.0e9)*Xz([1 3 5 7]),lambdaz,phiz*180/pi,6.3*ones(4,1),'WigSymplectic4Pass');
% W11 = wiggler('W11',L_wig,4,6,0.2998/(GLOBVAL.E0/1.0e9)*B_matrix,lambdaz,phiz*180/pi,kx,'WigSymplectic4Pass');
% W11 = wiggler('W11',L_wig,1,1,0.2998*1.94/(GLOBVAL.E0/1.0e9),0.114,0,6.3,'WigSymplectic4Pass');
% W11 = wiggler('W11',L_wig,1,1,0.2998*1.94/(GLOBVAL.E0/1.0e9),0.114,0,6.3,'DriftPass');
...
SUP  = [   L1 L2 BPM L3 QF L4 L5 QD  ...
           ...
           BPM L26  L27 ];
SUPW  = [   L1W L2 BPM L3 QF L4 L5 QD  ...
           L6 BPM L7 L8 BEND L9 SD L10 ... 
           BPM L11 QFA L12  SF L13 BPM  ...
           L14 BEND L15 BPM L16  SF  L17  ...
           QFA L18 BPM L19  SD L20 BEND L21 ... 
...
ELIST = [INJ SECT1 SUP SECT2 SUP SECT3 CAV SUP SECT4 SUPSW SECT5 W11 SUPW SECT6 SUP ...
