...
%% crab cavity
CRABCAV=crabcavity('CRABCAV', -0.0179, 1.5e6, 3*HarmNumber*C0/L0, 'ThinCrabCavityPass');
...
% DRIFT SPACES
   ...
   L1crab = drift('L1crab',  2.832695-0.221, 'DriftPass');
   L2crab = drift('L2crab',  0.45698+0.221, 'DriftPass');
   ...
   L26crab = drift('L26crab',  0.45698+0.22, 'DriftPass');
   L27crab = drift('L27crab',  2.832696-0.22, 'DriftPass');
...
SUP  = [   L1 L2 BPM L3 QF L4 L5 QD  ...
           ...
           BPM L26  L27 ];
SUPCRAB  = [   L1crab CRABCAV L2crab BPM L3 QF L4 L5 QD  ...
           L6 BPM L7 L8 BEND L9 SD L10 ... 
           BPM L11 QFA L12  SF L13 BPM  ...
           L14 BEND L15 BPM L16  SF  L17  ...
           QFA L18 BPM L19  SD L20 BEND L21 ... 
           BPM L22 QD L23  L24 QF L25  ...
           BPM L26crab CRABCAV  L27crab ];
...
ELIST = [INJ SECT1 SUP SECT2 SUP SECT3 CAV SUP SECT4 SUPS SECT5 SUP SECT6 SUPCRAB ...
