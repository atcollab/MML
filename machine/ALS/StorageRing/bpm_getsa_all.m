...
% No spliter + PT
% %Prefix_Extra =   {'SR01C:BPM1'; 'SR01C:BPM2'; 'SR01C:BPM3'; 'SR01C:BPM4'; 'SR01C:BPM5'; 'SR01C:BPM6'; 'SR01C:BPM7'; 'SR01C:BPM8'; };
% %Prefix_All = Prefix_Extra; 
Prefix_Extra =   {'SR01C:BPM1'; 'SR01C:BPM3'; 'SR01C:BPM5'; };
Prefix_All = [Prefix_Extra; Prefix_All;];
% %Prefix_All = Prefix_Extra;
  
%Prefix_All =   {'SR01C:BPM1'; 'SR01C:BPM2'; 'SR01C:BPM3'; 'SR01C:BPM4'; 'SR01C:BPM5'; 'SR01C:BPM6'; 'SR01C:BPM7'; 'SR01C:BPM8'; };
...
RFPV = strvcat(RFPV, 'MOCounter:FREQUENCY');

iBergoz = length(RFPV) + 1;
...
if 0
    % Add the split Bergoz
    RFPV = strvcat(RFPV, 'SR01C___BPM6XT_AM00');  % Bergoz on spliter
    RFPV = strvcat(RFPV, 'SR01C___BPM6YT_AM00');  % Bergoz on spliter
    d = [d; [1 7]]
end
...
%save SA_All_2Bunch_Set3

save SA_All_OwlShift_Set2

%save SA_All_3rdHarmScan_250mA_Set2
%save SA_All_2Bunch_Set12
%save SA_All_2Bunch_Sector1_10Min_Set2
%save SA_All_1Bunch_Sector1_RFChange_Set2
%save SA_All_1Bunch_Sector1_Set2
 
%  30 seconds PT Lo/Hi On not enabled  :00 t0   :30
% 120 seconds PT Lo/Hi On,    enabled   30 to  2:30
% 120 seconds PT    Hi On,    enabled 2:30 to  4:30
% 120 seconds PT Lo/Hi Off,   enabled 4:30 to  6:30
% 120 seconds PT Lo    On,    enabled 6:30 to  8:30 excess variation???
% 120 seconds PT Lo/Hi On,    enabled 8:30 to 10:00
