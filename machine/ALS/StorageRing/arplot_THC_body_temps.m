function arplot_THC_body_temps(monthStr, days, year1, month2Str, days2, year2)
% arplot_THC_body_temps(Month1 String, Days1, Year1, Month2 String, Days2, Year2)
%
% Plots THC body temps and powers, LCW temp, and beam current.
%
...
Cav1_body_TC = []; Cav1_body_LCW_flow = [];
Cav2_body_TC = []; Cav2_body_LCW_flow = [];
Cav3_body_TC = []; Cav3_body_LCW_flow = [];
...
for day = days
    ...
    Cav1_body_TC = [Cav1_body_TC y1];
    Cav2_body_TC = [Cav2_body_TC y2];
    Cav3_body_TC = [Cav3_body_TC y3];
...
%subfig(1,2,1,h);
subplot(5,1,1);
plot(t, Cav1_body_TC, t, Cav2_body_TC, t, Cav3_body_TC);
grid on;
ylabel('Temp [deg C]');
