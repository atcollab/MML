function arplot_orbitfb4(monthStr, days, year1, month2Str, days2, year2)
% arplot_orbitfb4(Month1 String, Days1, Year1, Month2 String, Days2, Year2)
%
% Plots archived data about the orbit feedback: plots the corrector
%       trim AM values (e.g., SR04C___VCM1T__AM00)
...
for day = days
    ...
    [y1, i] = arselect('SR01C___HCM2T__AM');
    hcm12 = [hcm12 y1];

    [y1, i] = arselect('SR01C___HCM4T__AM');
    hcm18 = [hcm18 y1];

    [y1, i] = arselect('SR02C___HCM1T__AM');
    hcm21 = [hcm21 y1];

    [y1, i] = arselect('SR02C___HCM4T__AM');
    hcm28 = [hcm28 y1];

    [y1, i] = arselect('SR03C___HCM1T__AM');
    hcm31 = [hcm31 y1];

    [y1, i] = arselect('SR03C___HCM4T__AM');
    hcm38 = [hcm38 y1];

    [y1, i] = arselect('SR04U___HCM2___AM');
    hcmu310 = [hcmu310 y1];

    [y1, i] = arselect('SR04C___HCM1T__AM');
    hcm41 = [hcm41 y1];

    [y1, i] = arselect('SR04C___HCM4T__AM');
    hcm48 = [hcm48 y1];

    [y1, i] = arselect('SR05C___HCM1T__AM');
    hcm51 = [hcm51 y1];

    [y1, i] = arselect('SR05C___HCM4T__AM');
    hcm58 = [hcm58 y1];

    [y1, i] = arselect('SR06U___HCM2___AM');
    hcmu510 = [hcmu510 y1];

    [y1, i] = arselect('SR06C___HCM1T__AM');
    hcm61 = [hcm61 y1];

    [y1, i] = arselect('SR06C___HCM4T__AM');
    hcm68 = [hcm68 y1];

    [y1, i] = arselect('SR07C___HCM1T__AM');
    hcm71 = [hcm71 y1];

    [y1, i] = arselect('SR07C___HCM4T__AM');
    hcm78 = [hcm78 y1];

    [y1, i] = arselect('SR08C___HCM1T__AM');
    hcm81 = [hcm81 y1];

    [y1, i] = arselect('SR08C___HCM4T__AM');
    hcm88 = [hcm88 y1];

    [y1, i] = arselect('SR09C___HCM1T__AM');
    hcm91 = [hcm91 y1];

    [y1, i] = arselect('SR09C___HCM4T__AM');
    hcm98 = [hcm98 y1];

    [y1, i] = arselect('SR10C___HCM1T__AM');
    hcm101 = [hcm101 y1];

    [y1, i] = arselect('SR10C___HCM4T__AM');
    hcm108 = [hcm108 y1];

    [y1, i] = arselect('SR11U___HCM2___AM');
    hcmu1010 = [hcmu1010 y1];

    [y1, i] = arselect('SR11C___HCM1T__AM');
    hcm111 = [hcm111 y1];

    [y1, i] = arselect('SR11C___HCM4T__AM');
    hcm118 = [hcm118 y1];

    [y1, i] = arselect('SR12C___HCM1T__AM');
    hcm121 = [hcm121 y1];

    [y1, i] = arselect('SR12C___HCM3T__AM');
    hcm127 = [hcm127 y1];

    [y1, i] = arselect('SR01C___VCM2T__AM');
    vcm12 = [vcm12 y1];

    [y1, i] = arselect('SR01C___VCM3T__AM');
    vcm17 = [vcm17 y1];

    [y1, i] = arselect('SR01C___VCM4T__AM');
    vcm18 = [vcm18 y1];

    [y1, i] = arselect('SR02C___VCM1T__AM');
    vcm21 = [vcm21 y1];

    [y1, i] = arselect('SR02C___VCM2T__AM');
    vcm22 = [vcm22 y1];

    [y1, i] = arselect('SR02C___VCM3T__AM');
    vcm27 = [vcm27 y1];

    [y1, i] = arselect('SR02C___VCM4T__AM');
    vcm28 = [vcm28 y1];

    [y1, i] = arselect('SR03C___VCM1T__AM');
    vcm31 = [vcm31 y1];

    [y1, i] = arselect('SR03C___VCM2T__AM');
    vcm32 = [vcm32 y1];

    [y1, i] = arselect('SR03C___VCM3T__AM');
    vcm37 = [vcm37 y1];

    [y1, i] = arselect('SR03C___VCM4T__AM');
    vcm38 = [vcm38 y1];

    [y1, i] = arselect('SR04U___VCM2___AM');
    vcmu310 = [vcmu310 y1];

    [y1, i] = arselect('SR04C___VCM1T__AM');
    vcm41 = [vcm41 y1];

    [y1, i] = arselect('SR04C___VCM2T__AM');
    vcm42 = [vcm42 y1];

    [y1, i] = arselect('SR04C___VCM3T__AM');
    vcm47 = [vcm47 y1];

    [y1, i] = arselect('SR04C___VCM4T__AM');
    vcm48 = [vcm48 y1];

    [y1, i] = arselect('SR06U___VCM2___AM');
    vcmu510 = [vcmu510 y1];

    [y1, i] = arselect('SR05C___VCM1T__AM');
    vcm51 = [vcm51 y1];

    [y1, i] = arselect('SR05C___VCM2T__AM');
    vcm52 = [vcm52 y1];

    [y1, i] = arselect('SR05C___VCM3T__AM');
    vcm57 = [vcm57 y1];

    [y1, i] = arselect('SR05C___VCM4T__AM');
    vcm58 = [vcm58 y1];

    [y1, i] = arselect('SR06C___VCM1T__AM');
    vcm61 = [vcm61 y1];

    [y1, i] = arselect('SR06C___VCM2T__AM');
    vcm62 = [vcm62 y1];

    [y1, i] = arselect('SR06C___VCM3T__AM');
    vcm67 = [vcm67 y1];

    [y1, i] = arselect('SR06C___VCM4T__AM');
    vcm68 = [vcm68 y1];

    [y1, i] = arselect('SR07C___VCM1T__AM');
    vcm71 = [vcm71 y1];

    [y1, i] = arselect('SR07C___VCM2T__AM');
    vcm72 = [vcm72 y1];

    [y1, i] = arselect('SR07C___VCM3T__AM');
    vcm77 = [vcm77 y1];

    [y1, i] = arselect('SR07C___VCM4T__AM');
    vcm78 = [vcm78 y1];

    [y1, i] = arselect('SR08C___VCM1T__AM');
    vcm81 = [vcm81 y1];

    [y1, i] = arselect('SR08C___VCM2T__AM');
    vcm82 = [vcm82 y1];

    [y1, i] = arselect('SR08C___VCM3T__AM');
    vcm87 = [vcm87 y1];

    [y1, i] = arselect('SR08C___VCM4T__AM');
    vcm88 = [vcm88 y1];

    [y1, i] = arselect('SR09C___VCM1T__AM');
    vcm91 = [vcm91 y1];

    [y1, i] = arselect('SR09C___VCM2T__AM');
    vcm92 = [vcm92 y1];

    [y1, i] = arselect('SR09C___VCM3T__AM');
    vcm97 = [vcm97 y1];

    [y1, i] = arselect('SR09C___VCM4T__AM');
    vcm98 = [vcm98 y1];

    [y1, i] = arselect('SR10C___VCM1T__AM');
    vcm101 = [vcm101 y1];

    [y1, i] = arselect('SR10C___VCM2T__AM');
    vcm102 = [vcm102 y1];

    [y1, i] = arselect('SR10C___VCM3T__AM');
    vcm107 = [vcm107 y1];

    [y1, i] = arselect('SR10C___VCM4T__AM');
    vcm108 = [vcm108 y1];

    [y1, i] = arselect('SR11U___VCM2___AM');
    vcmu1010 = [vcmu1010 y1];

    [y1, i] = arselect('SR11C___VCM1T__AM');
    vcm111 = [vcm111 y1];

    [y1, i] = arselect('SR11C___VCM2T__AM');
    vcm112 = [vcm112 y1];

    [y1, i] = arselect('SR11C___VCM3T__AM');
    vcm117 = [vcm117 y1];

    [y1, i] = arselect('SR11C___VCM4T__AM');
    vcm118 = [vcm118 y1];

    [y1, i] = arselect('SR12C___VCM1T__AM');
    vcm121 = [vcm121 y1];

    [y1, i] = arselect('SR12C___VCM2T__AM');
    vcm122 = [vcm122 y1];

    [y1, i] = arselect('SR12C___VCM3T__AM');
    vcm127 = [vcm127 y1];
