...
labelstr = 'New ALS BPM [5 9]';
dt = 1/10000;

setpvonline('SR05C:BPM8:wfr:FA:acqCount',50000);
setpvonline('SR05C:BPM8:wfr:FA:triggerMask',bin2dec('01000011'));
setpvonline('SR05C:BPM8:EVR:event12trig',bin2dec('01000000'));

while 1

    setpvonline('SR05C:BPM8:wfr:FA:arm',1);
    pause(6);
    
    bpmx=getpvonline('SR05C:BPM8:wfr:FA:c0')/1e6*sqrt(22/23);
    bpmy=getpvonline('SR05C:BPM8:wfr:FA:c1')/1e6*sqrt(5/8);
