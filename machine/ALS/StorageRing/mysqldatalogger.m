...
% Edit the above text to modify the response to help mysqldatalogger

% Last Modified by GUIDE v2.5 17-Mar-2006 17:12:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mysqldatalogger_OpeningFcn, ...
                   'gui_OutputFcn',  @mysqldatalogger_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mysqldatalogger is made visible.
function mysqldatalogger_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mysqldatalogger (see VARARGIN)

% Choose default command line output for mysqldatalogger
handles.output = 'Yes';
...
% UIWAIT makes mysqldatalogger wait for user response (see UIRESUME)
uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = mysqldatalogger_OutputFcn(hObject, eventdata, handles)
...
if isequal(get(handles.figure1, 'waitstatus'), 'waiting')
    ...
    %  delete(handles.figure1);  % Get done in mysqldatalogger_OutputFcn  (GJP)
end
