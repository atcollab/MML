...
for loop=1:length(BPMnames)
    ...
    setpvonline([BPMnames{loop}(1:end-4) 'EVR:event48trig'],bin2dec('01000000'));
...
% if the fine delay is being used, target a fixed bucket and modify fine delays instead    
    Req = srinjectoneshot(308, 4, 40, 0);
