...
subplot(3,1,2);
h1=semilogy(t, SR01IG1, t, SR01IG2, t, IG1(1,:), t, SR02IG1, t, IG1(2,:), t, SR03IG1, t, SR03IG3, t, IG1(3,:) ,'--');
for h = 1:length(h1)
    set(h1(h),'LineWidth',3)
end
grid on;
ylabel('IG [torr]');
axis([xmin xmax 1e-11 1e-7]);
clear name;
for j = 1:12
...
subplot(3,1,3);
h2=semilogy(t, SR04IG1, t, SR04IG2, t, IG1(4,:), t, SR05IG1, t, IG1(5,:), t, IG1(6,:), t, SR06IG1, t, SR06IG2 ,'--');
for h = 1:length(h2)
