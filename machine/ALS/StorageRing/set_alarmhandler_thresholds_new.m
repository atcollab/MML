function set_alarmhandler_thresholds_new
...
elseif strcmp(sr_mode_title, '1.9 GeV, High Tune') || strcmp(sr_mode_title, '1.9 GeV, Inject at 1.23') ...
        || strcmp(sr_mode_title, '1.5 GeV, Inject at 1.23')
    try
...
%AHU Temps
try
    disp('   Setting AHU Temperature limits to HIGH = 22 C, HIHI = 23 C');
    ...
    scaput('SR04C___AHUT___AM00.HIGH', 22); scaput('SR04C___AHUT___AM00.HIHI', 23);
    scaput('SR06C___AHUT___AM00.HIGH', 22); scaput('SR06C___AHUT___AM00.HIHI', 23);
    scaput('SR07C___AHUT___AM00.HIGH', 22); scaput('SR07C___AHUT___AM00.HIHI', 23);
    scaput('SR08C___AHUT___AM00.HIGH', 22); scaput('SR08C___AHUT___AM00.HIHI', 23);
    scaput('SR09C___AHUT___AM00.HIGH', 22); scaput('SR09C___AHUT___AM00.HIHI', 23);
    scaput('SR11C___AHUT___AM00.HIGH', 22); scaput('SR11C___AHUT___AM00.HIHI', 23);
catch
