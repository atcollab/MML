function varargout = epbitest2_Backup_2016_05_31(varargin)
% EPBITEST2_BACKUP_2016_05_31 MATLAB code for epbitest2_Backup_2016_05_31.fig
%      EPBITEST2_BACKUP_2016_05_31, by itself, creates a new EPBITEST2_BACKUP_2016_05_31 or raises the existing
%      singleton*.
%
%      H = EPBITEST2_BACKUP_2016_05_31 returns the handle to a new EPBITEST2_BACKUP_2016_05_31 or the handle to
%      the existing singleton*.
%
%      EPBITEST2_BACKUP_2016_05_31('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EPBITEST2_BACKUP_2016_05_31.M with the given input arguments.
%
%      EPBITEST2_BACKUP_2016_05_31('Property','Value',...) creates a new EPBITEST2_BACKUP_2016_05_31 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before epbitest2_Backup_2016_05_31_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to epbitest2_Backup_2016_05_31_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help epbitest2_Backup_2016_05_31

% Last Modified by GUIDE v2.5 31-May-2016 16:24:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @epbitest2_Backup_2016_05_31_OpeningFcn, ...
    'gui_OutputFcn',  @epbitest2_Backup_2016_05_31_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before epbitest2_Backup_2016_05_31 is made visible.
function epbitest2_Backup_2016_05_31_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to epbitest2_Backup_2016_05_31 (see VARARGIN)

% Choose default command line output for epbitest2_Backup_2016_05_31
...
%EPBITEST2_BACKUP_2016_05_31 = getepbichannelnames(Sector);
%EPBITEST2_BACKUP_2016_05_31 = rmfield(EPBITEST2_BACKUP_2016_05_31, 'Throttle');
%setappdata(handles.figure1, 'EPBIStructure', EPBITEST2_BACKUP_2016_05_31);
...
% Setup HeaterControl Timer (may not be needed???)
% Note handles.GraphTimer will be missing from handles in this function
UpdatePeriod = 30;
t = timer;
set(t, 'StartDelay', 0);
set(t, 'Period', UpdatePeriod);
...
% UIWAIT makes epbitest2_Backup_2016_05_31 wait for user response (see UIRESUME)
...
%ChanNames = EPBITEST2_BACKUP_2016_05_31.(Names{HeaterSelect}).WF;
...
if ~any(isnan(EPBIData.TripIndex))
...
%             Names  = get(handles.HeaterSelect, 'UserData');
%             
%             %FileName = 'epbitest2_backup_2016_05_31';
...
function varargout = epbitest2_Backup_2016_05_31_OutputFcn(hObject, eventdata, handles)
...
if OnFlag
    ...
    start(handles.HeaterTimer);
else
    try
        HeaterOff = getappdata(handles.figure1, 'EPBIHeaterOff');
        setpvonline(HeaterOff, 1);
        if strcmpi(get(handles.HeaterTimer, 'Running'), 'on')
            stop(handles.HeaterTimer);
            %delete(handles.HeaterTimer);
        end
        drawnow;
        setpvonline(HeaterOff, 1);
...
handles2 = getappdata(handles.figure1, 'Handles');
if ~isempty(handles2)
    handles = handles2;
end
...
if Value == 0  % strcmp(State, 'Running');
    ...
    try
        ...
        %fprintf('Debug warning: issue with handles.HeaterTimer in OnOffButton_Callback.  Just moving on.\n');
        aaa=1;
    end
else
    % Turn on
