...
GoldData.Data(:,1)=GoldData.Data(1,1)+filter(b,a,GoldData.Data(:,1)-GoldData.Data(1,1));
GoldData.Data(:,2)=GoldData.Data(1,2)+filter(b,a,GoldData.Data(:,2)-GoldData.Data(1,2));
GoldData.Data(:,3)=GoldData.Data(1,3)+filter(b,a,GoldData.Data(:,3)-GoldData.Data(1,3));
...
% Use DVM waveform readacks or new direct readback from DPSCs
DVM_FILE = 0;
    ...
    if DVM_FILE==1
        ...
        NewData.Data(:,1)=(Data.Data(4,1)+filter(b,a,Data.Data(4:end,1)-Data.Data(4,1)))/125; 
        NewData.Data(:,2)=(Data.Data(4,3)+filter(b,a,Data.Data(4:end,3)-Data.Data(4,3)))/60; 
        NewData.Data(:,3)=(Data.Data(4,2)+filter(b,a,Data.Data(4:end,2)-Data.Data(4,2)))/60; 
...
if ~SkipFlag
    ...
    injtime=NewData.TimeStep*min(find((125*NewData.Data(:,1))>25));
    ...
    plot(handles.axes3, [injtime injtime],[0 1000],'k','LineWidth',2);
    ...
    plot(handles.axes4, [injtime injtime],[-1 1],'k','LineWidth',2);
    ...
    plot(handles.axes5, [injtime injtime],[0 100],'k','LineWidth',2);
    ...
    if (NewData.TimeStep == GoldData.TimeStep)
        ...
        plot(handles.axes6, [injtime injtime],[-1 1],'k','LineWidth',2);
    ...
    if (NewData.TimeStep == GoldData.TimeStep)
        ...
        plot(handles.axes7, [injtime injtime],[-1 1],'k','LineWidth',2);
