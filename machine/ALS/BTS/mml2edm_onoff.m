...
FileName = 'MML2EDM_BTS_ONOFF.edl';
...
% Main title
WriteEDMFile(fid, EDMStaticText('BTS On/Off', ceil(14*WidthRatio), 10, 'Width', 200, 'FontSize',24, 'FontWeight','bold', 'HorizontalAlignment','center'));
