...
set(handles.StandardizetoGoldenLattice, 'Label', 'Standardize to Injection Lattice - btscycle(''Injection'')');
set(handles.StandardizetoGoldenLattice, 'Callback', 'set(gcbf,''HandleVisibility'',''off''); try; btscycle(''Injection'',''Display''); catch; fprintf(''%s\n'',lasterr); set(gcbf,''HandleVisibility'',''Callback''); disp(''   An error occurred standardizing the BTS lattice''); end; set(gcbf,''HandleVisibility'',''Callback'');');

set(handles.StandardizetoUserSelectableLatticeFile, 'Label', 'Standardize to User Selectable Lattice File - btscycle('''')');
set(handles.StandardizetoUserSelectableLatticeFile, 'Callback', 'set(gcbf,''HandleVisibility'',''off''); try; btscycle('''',''Display''); catch; fprintf(''%s\n'',lasterr); set(gcbf,''HandleVisibility'',''Callback''); disp(''   An error occurred standardizing the GTB lattice''); end; set(gcbf,''HandleVisibility'',''Callback'');');
