function varargout = orbitx1(varargin)
% ORBITX1 M-file for orbitx1.fig
%      ORBITX1, by itself, creates a new ORBITX1 or raises the existing
%      singleton*.
%
%      H = ORBITX1 returns the handle to a new ORBITX1 or the handle to
%      the existing singleton*.
%
%      ORBITX1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ORBITX1.M with the given input arguments.
%
%      ORBITX1('Property','Value',...) creates a new ORBITX1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before orbitx1_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to orbitx1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help orbitx1

% Last Modified by GUIDE v2.5 06-Dec-2005 10:01:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @orbitx1_OpeningFcn, ...
                   'gui_OutputFcn',  @orbitx1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before orbitx1 is made visible.
function orbitx1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to orbitx1 (see VARARGIN)

% Choose default command line output for orbitx1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes orbitx1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = orbitx1_OutputFcn(hObject, eventdata, handles) 
