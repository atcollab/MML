...
% ep
    ...
    temp=tango_read_attribute2('ANS-C01/EP/AL_SEP_P.1','serialVoltage');    boo.ANS_SPvoltage=temp.value(2);
    temp=tango_read_attribute2('ANS-C01/EP/AL_SEP_A','voltage');            boo.ANS_SAvoltage=temp.value(2);
