function varargout = NombreOnde_AL(varargin)
% NOMBREONDE_AL M-file for NombreOnde_AL.fig
%      NOMBREONDE_AL, by itself, creates a new NOMBREONDE_AL or raises the existing
%      singleton*.
%
%      H = NOMBREONDE_AL returns the handle to a new NOMBREONDE_AL or the handle to
%      the existing singleton*.
%
%      NOMBREONDE_AL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NOMBREONDE_AL.M with the given input arguments.
%
%      NOMBREONDE_AL('Property','Value',...) creates a new NOMBREONDE_AL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NombreOnde_AL_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NombreOnde_AL_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NombreOnde_AL
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @NombreOnde_AL_OpeningFcn, ...
                   'gui_OutputFcn',  @NombreOnde_AL_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NombreOnde_AL is made visible.
function NombreOnde_AL_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NombreOnde_AL (see VARARGIN)

if ~strcmp(getfamilydata('SubMachine'),'Booster')
    error('Load Bosster first');
end

% Choose default command line output for NombreOnde_AL
handles.Stop_NO = 0;
...
function varargout = NombreOnde_AL_OutputFcn(hObject, eventdata, handles) 
...
set(handles.Position_X,'YLim',[-5 5]);
