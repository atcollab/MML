...
function [merit,CorConsEye,BpmRes,offs,OffsCor,center,ze,ord1,ord2,BpmEyeRes,CorDevListRes,iniCor,rmsFit,NameFile,NameFilePNG]=bba_last(RepRes,QuadFam,QuadDev,Plane,Method,nbDeltaCor,DeltaCor,offsetCor,retard,DeltaQp0,CorNumber)
%% INPUTS
    ...
    if strcmpi(Method,'MEC')
        ...
        for v=1:nbDeltaQp
            ...
            for u=1:nbDeltaCor
                ...
                CorCons(u)=CorTab(u); % tentative 29 janvier
