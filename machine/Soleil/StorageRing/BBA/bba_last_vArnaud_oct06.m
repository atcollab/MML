...
%Rep='/home/matlabML/measdata/Ringdata/BBA';
Rep    = getfamilydata('Directory','BBA');
RepRes = [Rep '/work3'];
%RepRes=[Rep '/debug'];

%Rep=pwd;
%RepRes=[Rep '/DirBBA'];%dir(RepertRes)vv
varfig=10; % utilité ??????
...
[BBAnumb0, BBAnumbText0, NomText0]=SaveName(0);
...
if BBAnumb0>0
    ...
    NameFile=[RepRes '/' NomText0];
    %NameFile=[RepRes '/ResBBA_' BBAnumbText0 '_' texdat '.mat'];
    load(NameFile);
end
%BBA;
%définition du nom du nouveau fichier résultat BBA
[BBAnumb1,BBAnumbText1,NomText1]=SaveName(1);  %NomText1 n'est pas utulisé dans ce cas
%NameFile=[RepRes '/ResBBA_' BBAnumbText1 '.mat'];
NameFile=[RepRes '/ResBBA_' BBAnumbText1 '_' texdat '.mat'];
