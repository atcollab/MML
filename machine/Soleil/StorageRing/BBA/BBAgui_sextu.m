function BBAgui_sextu(arg1,arg2)
...
if nargin<1 %Créer l'IHM
    ...
    radNone=uicontrol('Parent',AllQP,...
        ...
        'String', 'None',...
        'Units','pixels',...
        'Callback',      'BBAgui_sextu(''typeNone'')',...
        'Tag',   'radio_None',...
        'Value',0,...
    ...
    for i=1:10%10
        ...
        radAll(i)=uicontrol('Parent',hp(i),...
            ...
            'Units','pixels',...
            'Callback',      'BBAgui_sextu(''familyAll'')',...
            'Tag',   NameRadioAll,...
            'Value',0,...
        ...
        radNone(i)=uicontrol('Parent',hp(i),...
            ...
            'Units','pixels',...
            'Callback',      'BBAgui_sextu(''familyNone'')',...
            'Tag',   NameRadioNone,...
            'Value',0,...
        ...
        for j=1:length(QuadDevList)
            ...
            cont(i,j)=uicontrol('Parent',hp(i),...
                ...
                'String', NameQuadDev,...
                'Units','pixels',...
                'Callback',   'BBAgui_sextu(''check'')'   ,...%'BBAgui_sextu(''Ncheck'')'
                'Tag',   NameControl,...
...
elseif strcmpi(arg1,'manu')  % bouton manuel/auto
    ...
    %%
elseif strcmpi(arg1,'action')  % ressortir les checkbox coch�es
...
%    cellule;
 ...
 %   QpDevList
    longElem=1
    indice=10; %indice permet de num�roter les figures
    for w=1:longElem
        %indice=indice+1;
...
%           set(f,'String',TextQp1);
            ...
            for t=1:maxloop
                ...
                drawnow
                [merit,CorCons,BpmDevRes,offs,OffsCor,center,ze,ord1,ord2,BpmRes,iniCor,rmsFit]=bba_sextu('QT',PlaneList0(loop),char(MetList),nbDeltaCor,StepCor,OffCor,Delais,StepQp);
                %center
