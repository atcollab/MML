...
Q1   =  quadrupole('Q1' , 0.32,  -1.187598, 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,   0.1715087E+01, 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,  -0.7313051E+00 , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,  -0.1398635E+01, 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,   0.1891610E+01, 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,  -0.1127630E+01, 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,  0.2220677E+01, 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,  -0.1708808E+01, 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,  -0.1688424E+01, 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,  0.1961364E+01, 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv, 0.1413193E+01*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv,-0.3676406E+01*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv,-0.2379549E+01*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv, 0.3826273E+01*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv,-0.4528983E+01*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,0.3980921E+01*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv,-0.4511492E+01*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,0.3873620E+01*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv,-0.2958732E+01*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,0.1894065E+01*F, 'StrMPoleSymplectic4Pass');
