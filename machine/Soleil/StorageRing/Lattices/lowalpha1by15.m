function varargout = lowalpha1by15
...
CAV = rfcavity('RF' , 0 , 1.4e+6 , HarmNumber*C0/L0, ...
    HarmNumber ,'CavityPass');
...
de=1-4e-3*0;
Q1   =  quadrupole('Q1' , 0.32,  -1.237123*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,   1.778681*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,  -0.9059312*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,  -1.105390*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,   1.910066*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,  -1.803362*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,   2.011418*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,  -0.5106047*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,  -1.341271*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,   2.048837*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  0.8442831*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -3.631550*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -3.670993*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  4.910700*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -2.635539*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  2.677307*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -3.245237*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  3.030515*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -3.960253*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  3.553240*F, 'StrMPoleSymplectic4Pass');
