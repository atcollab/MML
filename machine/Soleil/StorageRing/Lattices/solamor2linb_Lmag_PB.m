...
dc=0.035/2;
dl=0.030/2;
SD13= drift('SD13', 3.48255-dc, 'DriftPass');
SD1 = drift('SD1',  6.00000-dc, 'DriftPass');
...
SD2 = drift('SD2',  0.39000-dc, 'DriftPass');
SD3 = drift('SD3',  0.20000-dl, 'DriftPass');
SD4 = drift('SD4',  0.39000-dl, 'DriftPass');
SD14= drift('SD14', 0.59000-dl-dc, 'DriftPass');
SD5 = drift('SD5',  0.20000-dc, 'DriftPass');
SD6 = drift('SD6',  0.79000, 'DriftPass');
SD7 = drift('SD7',  0.44000-dc, 'DriftPass');
SD8 = drift('SD8',  0.20000-dc, 'DriftPass');
SD9 = drift('SD9',  0.47634-dc, 'DriftPass');
SD10= drift('SD10', 0.47000-dc, 'DriftPass');
SD12= drift('SD12', 0.47000-dc, 'DriftPass');
...
Q1   =  quadrupole('Q1' , 0.32+2*dc,  -1.193917 , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46+2*dl,   1.712124 , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32+2*dc,  -0.7195554 , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32+2*dc,  -1.404293 , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32+2*dc,   1.895744 , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32+2*dc,  -1.117271 , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46+2*dl,   2.223070 , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32+2*dc,  -1.724227 , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32+2*dc,  -1.689030 , 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32+2*dc,   1.963458 , 'QuadLinearPass');
