...
%% QUADRUPOLES (compensation de l'effet des d�fauts de focalisation des
%% dipoles P. Brunelle 02/05/06)
Q1   =  quadrupole('Q1' , 0.32,  -0.1208383E+01 , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,   0.1733100E+01 , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,  -0.6815000E+00 , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,  -0.1410059E+01 , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,  0.1852924E+01 , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,  -0.1110955E+01 , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,  0.2236893E+01 , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,  -0.1666879E+01 , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,  -0.1729959E+01 , 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,  0.1923157E+01 , 'QuadLinearPass');


%% SEXTUPOLES chromaticit�s nulles dans TracyII 
%avec d�fauts de focalisation des dip�les 
%P. Brunelle 02/05/06
F = 1e8;
Finv = 1/F;

S1  =  sextupole('S1' , Finv,  0.1839305e+1*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -0.3764840e+1*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -0.2292670e+1*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  0.3706230e+1*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -0.4649209e+1*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv, 0.4300591e+1*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -0.4641336e+1*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv, 0.3730192e+1*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -0.1947013e+1*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv, 0.1170339e+1*F, 'StrMPoleSymplectic4Pass');
