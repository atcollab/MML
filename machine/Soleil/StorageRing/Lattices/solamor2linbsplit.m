...
Q1s   =  quadrupole('Q1' , 0.32/2,  -1.193917*de , 'QuadLinearPass');
Q2s   =  quadrupole('Q2' , 0.46/2,   1.712124*de , 'QuadLinearPass');
Q3s   =  quadrupole('Q3' , 0.32/2,  -0.7195554*de , 'QuadLinearPass');
Q4s   =  quadrupole('Q4' , 0.32/2,  -1.404293*de , 'QuadLinearPass');
Q5s   =  quadrupole('Q5' , 0.32/2,   1.895744*de , 'QuadLinearPass');
Q6s   =  quadrupole('Q6' , 0.32/2,  -1.117271*de , 'QuadLinearPass');
Q7s   =  quadrupole('Q7' , 0.46/2,   2.223070*de , 'QuadLinearPass');
Q8s   =  quadrupole('Q8' , 0.32/2,  -1.724227*de , 'QuadLinearPass');
Q9s   =  quadrupole('Q9' , 0.32/2,  -1.689030*de , 'QuadLinearPass');
Q10s  =  quadrupole('Q10', 0.32/2,   1.963458*de , 'QuadLinearPass');
