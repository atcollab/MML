...
a9=1+a*3.4e-3;
a10=1+a*2.5e-3;
Q1   =  quadrupole('Q1' , 0.32,  -1.193917*a1 , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,   1.712124*a2 , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,  -0.7195554*a3 , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,  -1.404293*a4 , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,   1.895744*a5 , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,  -1.117271*a6 , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,   2.223070*a7 , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,  -1.724227*a8 , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,  -1.689030*a9 , 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,   1.963458*a10 , 'QuadLinearPass');
...
S9  =  sextupole('S9' , Finv, -3.4549*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  2.091301*F, 'StrMPoleSymplectic4Pass');
