...
de=1-4e-3*0;
Q1   =  quadrupole('Q1' , 0.32,  -1.187598*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,   1.715087*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,  -0.7313051*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,  -1.398635*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,   1.891610*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,  -1.127630*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,   2.220677*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,  -1.708808*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,  -1.688424*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,   1.961364*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  1.413193*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -3.676406*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -2.379549*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  3.826273*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -4.528983*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  3.980921*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -4.511492*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  3.873620*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -2.958732*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  1.894065*F, 'StrMPoleSymplectic4Pass');
