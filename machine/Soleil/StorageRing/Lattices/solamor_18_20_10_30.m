...
CAV = rfcavity('RF' , 0 , 1.3e+6 , HarmNumber*C0/L0, ...
    HarmNumber ,'CavityPass');
...
SD13a= drift('SD13a', 3.141452 + 8.3334e-8	, 'DriftPass');
...
Q1   =  quadrupole('Q1' , 0.32,  -1.19278*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,   1.71626*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,  -0.73523*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,  -1.39066*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,   1.88129*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,  -1.15309*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,   2.24564*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,  -1.70671*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,  -1.67538*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,   1.95238*de , 'QuadLinearPass');
...
S1  =  sextupole('S1' , Finv,  1.72600674*F, 'StrMPoleSymplectic4Pass');
S2  =  sextupole('S2' , Finv, -4.12083441*F, 'StrMPoleSymplectic4Pass');
S3  =  sextupole('S3' , Finv, -2.17798074*F, 'StrMPoleSymplectic4Pass');
S4  =  sextupole('S4' , Finv,  3.61894236*F, 'StrMPoleSymplectic4Pass');
S5  =  sextupole('S5' , Finv, -3.71287256*F, 'StrMPoleSymplectic4Pass');
S6  =  sextupole('S6' , Finv,  3.25954369*F, 'StrMPoleSymplectic4Pass');
S7  =  sextupole('S7' , Finv, -5.02335803*F, 'StrMPoleSymplectic4Pass');
S8  =  sextupole('S8' , Finv,  4.21034754*F, 'StrMPoleSymplectic4Pass');
S9  =  sextupole('S9' , Finv, -3.68397549*F, 'StrMPoleSymplectic4Pass');
S10 =  sextupole('S10', Finv,  2.26830779*F, 'StrMPoleSymplectic4Pass');
...
DirSpec   =  getfamilydata('Directory','ConfigData');
FileName = 'CNF_9juillet_160sym_0_2_0_3.mat';
cnf=load([DirSpec FileName]);

families = findmemberof('QUAD');

config=cnf.ConfigSetpoint;

setmachineconfig(families,config,'Model');
