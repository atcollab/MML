...
de=1-4e-3*0;
Q1   =  quadrupole('Q1' , 0.32,  -1.1938*de , 'QuadLinearPass');
Q2   =  quadrupole('Q2' , 0.46,   1.71199*de , 'QuadLinearPass');
Q3   =  quadrupole('Q3' , 0.32,  -0.71946*de , 'QuadLinearPass');
Q4   =  quadrupole('Q4' , 0.32,  -1.40415*de , 'QuadLinearPass');
Q5   =  quadrupole('Q5' , 0.32,   1.89559*de , 'QuadLinearPass');
Q6   =  quadrupole('Q6' , 0.32,  -1.11717*de , 'QuadLinearPass');
Q7   =  quadrupole('Q7' , 0.46,   2.23791*de , 'QuadLinearPass');
Q8   =  quadrupole('Q8' , 0.32,  -1.72690*de , 'QuadLinearPass');
Q9   =  quadrupole('Q9' , 0.32,  -1.69815*de , 'QuadLinearPass');
Q10  =  quadrupole('Q10', 0.32,   1.96329*de , 'QuadLinearPass');
