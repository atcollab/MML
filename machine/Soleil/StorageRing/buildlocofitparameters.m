...
switch ButtonName
    case 1
        ...
        if isfield(LocoFlags.Method.Cost, 'FitParameters')
            LocoFlags.Method.Cost = rmfield(LocoFlags.Method.Cost, 'FitParameters');
        end
    case 2
        ...
        for ii = 1:160, % specific weight for K-values
            ...
            LocoFlags.Method.Cost.FitParameters(ii,1) = .01;
        end
end
