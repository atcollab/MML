function Meffquad = getrespquad(varargin)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mesure de la matrice d'effcicaité comme sur la machine
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for k1 = 1:length(QuadFam),
    ...
    for k2 = 1:length(DeviceList),
        ...
        %Ic1 = getam(QuadFam{k1}, DeviceList(k2,:),'Model');
        %K1 = hw2physics(QuadFam{k1}, 'Setpoint', Ic+DeltaI, DeviceList(k2,:));
        
        % mesure de beta comme sur la machine delta I 
        beta_tune = mesure_beta(QuadFam);
        betaX1 = beta_tune(1,:);
        betaZ1 = beta_tune(2,:);
        ...
        % mesure de beta comme sur la machine -2delta I 
        beta_tune = mesure_beta(QuadFam);        
        betaX2 = beta_tune(1,:);
        betaZ2 = beta_tune(2,:);
