function varargout = synchro_injecteur7(varargin)
% SYNCHRO_INJECTEUR7 M-file for synchro_injecteur7.fig
...
% Edit the above text to modify the response to help synchro_injecteur7

% Last Modified by GUIDE v2.5 26-Feb-2007 15:22:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @synchro_injecteur7_OpeningFcn, ...
                   'gui_OutputFcn',  @synchro_injecteur7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before synchro_injecteur7 is made visible.
function synchro_injecteur7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to synchro_injecteur7 (see VARARGIN)

% Choose default command line output for synchro_injecteur7
...
% UIWAIT makes synchro_injecteur7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = synchro_injecteur7_OutputFcn(hObject, eventdata, handles) 
...
elseif (mode==8)    %LPM
    dbunch=4*8;
    bunch=[0 104+32 2*(104+40)]+1; % spécial 3/4
...
elseif (mode==12)  % SPM    n paquets
    ...
    if isempty(bunch);set(handles.edit_filling_entrer_bunch,'String','Bug format');end
...
switch mode  % Get Tag of selected object
    ...
    % test
       % tango_write_attribute2('ANS-C15/SY/LOCAL.TEST.1', 'test_gftyEvent',event);pause(tout); 
       % tango_write_attribute2('ANS-C15/SY/LOCAL.TEST.2', 'test2_gftyEvent',event);pause(tout); 
   ...
   % test
       % tango_write_attribute2('ANS-C15/SY/LOCAL.TEST.1', 'test_gftyEvent',event);pause(tout); 
       % tango_write_attribute2('ANS-C15/SY/LOCAL.TEST.2', 'test2_gftyEvent',int32(2));pause(tout); 
...
% test
        %tango_write_attribute2('ANS-C15/SY/LOCAL.TEST.1', 'test_gftyEvent',int16(5));
        %tango_write_attribute2('ANS-C15/SY/LOCAL.TEST.2', 'test2_gftyEvent',int16(5));
