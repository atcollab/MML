function varargout = timinggui_div(varargin)
% TIMINGGUI_DIV M-file for timinggui_div.fig
%      TIMINGGUI_DIV, by itself, creates a new TIMINGGUI_DIV or raises the existing
%      singleton*.
%
%      H = TIMINGGUI_DIV returns the handle to a new TIMINGGUI_DIV or the handle to
%      the existing singleton*.
%
%      TIMINGGUI_DIV('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TIMINGGUI_DIV.M with the given input arguments.
%
%      TIMINGGUI_DIV('Property','Value',...) creates a new TIMINGGUI_DIV or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before timinggui_div_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to timinggui_div_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help timinggui_div

% Last Modified by GUIDE v2.5 03-Apr-2006 18:40:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @timinggui_div_OpeningFcn, ...
                   'gui_OutputFcn',  @timinggui_div_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before timinggui_div is made visible.
function timinggui_div_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to timinggui_div (see VARARGIN)

% Choose default command line output for timinggui_div
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes timinggui_div wait for user response (see UIRESUME)
% uiwait(handles.figure1);

handles.device_carte1 ='BOO/SY/CPT.1';
handles.device_carte2 ='LT1/SY/CPT.1';
handles.device_carte3 ='BOO/SY/CPT.2';
handles.device_carte4 ='LIN/SY/FREQDIV';
...
str3 ={'divisionCounter0', 'divisionCounter1', 'divisionCounter2', ...
    'divisionCounter3', 'divisionCounter4', 'divisionCounter5', 'divisionCounter6', 'divisionCounter7'};
...
handles.divisionname4 = [repmat(handles.device_carte4,nb,1) repmat('/',nb,1) cell2mat(str3')];
...
handles.enablename4 = [repmat(handles.device_carte4,nb,1) repmat('/',nb,1) cell2mat(str2')];
...
% Reads all division for card #4
handles.divisionvalue4 = readattribute(handles.divisionname4);
...
function varargout = timinggui_div_OutputFcn(hObject, eventdata, handles) 
...
handles.enablevalue4 = readattribute(handles.enablename4);
% Reads all division for card #4
handles.divisionvalue4 = readattribute(handles.divisionname4);
...
% update display for Card4
for k = 1:1,
    set(handles.(['edit_div']),'String',num2str(handles.divisionvalue4(k),7));
    set(handles.(['checkbox_div']),'Value',handles.enablevalue4(k));
end
...
set(handles.checkbox_status4,'String',tango_command_inout2(handles.device_carte4,'State'))
...
if get(handles.checkbox_status4,'Value') == 1
    tango_command_inout2(handles.device_carte4,'Start');
end
...
if get(handles.checkbox_status4,'Value') == 1
    tango_command_inout2(handles.device_carte4,'Stop');
end
...
if get(handles.checkbox_status4,'Value') == 1
    tango_command_inout2(handles.device_carte4,cmd);
end
...
val = int32(str2double(get(hObject,'String')));
if val < 4
    warndlg('Not applied: minimum is 4')
else
    tango_write_attribute2(handles.device_carte4,['divisionCounter' num2str(0)],val);
end
...
% --- Executes on button press in checkbox_div.
function checkbox_div_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox_div (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox_div

val = uint8(get(hObject,'Value'));
 tango_write_attribute2(handles.device_carte4,['counter' num2str(0) 'Enable'],val);


% --- Executes on button press in checkbox_status4.
function checkbox_status4_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox_status4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox_status4
