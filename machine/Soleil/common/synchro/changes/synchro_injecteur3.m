function varargout = synchro_injecteur3(varargin)
% SYNCHRO_INJECTEUR3 M-file for synchro_injecteur3.fig
%      SYNCHRO_INJECTEUR3, by itself, creates a new SYNCHRO_INJECTEUR3 or raises the existing
%      singleton*.
%
%      H = SYNCHRO_INJECTEUR3 returns the handle to a new SYNCHRO_INJECTEUR3 or the handle to
%      the existing singleton*.
%
%      SYNCHRO_INJECTEUR3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SYNCHRO_INJECTEUR3.M with the given input arguments.
%
%      SYNCHRO_INJECTEUR3('Property','Value',...) creates a new SYNCHRO_INJECTEUR3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before synchro_injecteur3_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to synchro_injecteur3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help synchro_injecteur3

% Last Modified by GUIDE v2.5 22-Jun-2006 16:06:08

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @synchro_injecteur3_OpeningFcn, ...
                   'gui_OutputFcn',  @synchro_injecteur3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before synchro_injecteur3 is made visible.
function synchro_injecteur3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to synchro_injecteur3 (see VARARGIN)

% Choose default command line output for synchro_injecteur3
...
% UIWAIT makes synchro_injecteur3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = synchro_injecteur3_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in button_filling_14.
function button_filling_14_Callback(hObject, eventdata, handles)
% hObject    handle to button_filling_14 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
temp=tango_read_attribute('ANS/SY/CENTRAL', 'ExtractionOffsetClkStepValue');
offset=temp.value(1)*52;
...
% --- Executes on button press in button_filling_24.
function button_filling_24_Callback(hObject, eventdata, handles)
% hObject    handle to button_filling_24 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
temp=tango_read_attribute('ANS/SY/CENTRAL', 'ExtractionOffsetClkStepValue');
offset=temp.value(1)*52;
...
tango_command_inout('LT1/SY/LOCAL.LINAC.1','Update')
    
tango_command_inout('BOO/SY/LOCAL.DG.3', 'Update');       
tango_command_inout('BOO/SY/LOCAL.Binj.1',  'Update');  
tango_command_inout('BOO/SY/LOCAL.Bext.1',  'Update'); 
tango_command_inout('BOO/SY/LOCAL.Alim.1',  'Update'); 

tango_command_inout('LT2/SY/LOCAL.DG.2',  'Update'); 
tango_command_inout('LT2/SY/LOCAL.DG.1',  'Update'); 

tango_command_inout('ANS/SY/LOCAL.SDC.1',  'Update'); 
tango_command_inout('ANS-C01/SY/LOCAL.Ainj.1', 'Update'); 
tango_command_inout('ANS-C01/SY/LOCAL.Ainj.2',  'Update'); 
tango_command_inout('ANS-C01/SY/LOCAL.DG.2',  'Update'); 
tango_command_inout('ANS-C02/SY/LOCAL.DG.1',  'Update'); 
tango_command_inout('ANS-C03/SY/LOCAL.DG.1',  'Update'); 
tango_command_inout('ANS-C04/SY/LOCAL.DG.1',  'Update'); 
tango_command_inout('ANS-C05/SY/LOCAL.DG.1',  'Update'); 
tango_command_inout('ANS-C06/SY/LOCAL.DG.1',  'Update'); 
tango_command_inout('ANS-C07/SY/LOCAL.DG.1', 'Update'); 
tango_command_inout('ANS-C08/SY/LOCAL.DG.1',  'Update'); 
tango_command_inout('ANS-C09/SY/LOCAL.DG.1',  'Update'); 
tango_command_inout('ANS-C10/SY/LOCAL.DG.1', 'Update');   
tango_command_inout('ANS-C11/SY/LOCAL.DG.1', 'Update');   
tango_command_inout('ANS-C12/SY/LOCAL.DG.1',  'Update');   
tango_command_inout('ANS-C13/SY/LOCAL.DG.1',  'Update');   
tango_command_inout('ANS-C14/SY/LOCAL.DG.1',  'Update');   
tango_command_inout('ANS-C15/SY/LOCAL.DG.1',  'Update');   
tango_command_inout('ANS-C16/SY/LOCAL.DG.1',  'Update');    
