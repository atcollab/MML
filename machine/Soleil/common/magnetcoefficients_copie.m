...
%                 a0 =  0.0;
    ...
    case 'Ring'
        ...
        switch upper(deblank(MagnetCoreType))
            ...
            case 'BEND'   
                ...
                % D�calage en champ entre le dip�le de r�f�rence et les
    ...
    case 'LT2'
        ...
        switch upper(deblank(MagnetCoreType))
            ...
            case 'BEND'    
                % les coefficients sont recopiés de l'anneau
                % la longueur magnétique est différente du fait de la
                % déviation (et courant) différents
