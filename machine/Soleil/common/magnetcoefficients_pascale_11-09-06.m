...
%                 A = [a7 a6 a5 a4 a3 a2 a1 a0];
            ...
            case {'Q1','Q6'}  
                ...
                %facteur 8e-3 pour ajuster nux du 1er jour
...
%                 end
         % G. Portmann
            ...
            case {'Q7'}   % l= 460 mm 
                ...
                a7=  0.0;
                a6=  0.0;
                a5= 1.50427350E-9*bob;
                a4=  -1.52722610E-6*bob;
                a3= 6.16874120E-4*bob;
                a2=  -1.24044936E-1*bob;
                a1=  1.24707096E+01*bob;
                a0=  -4.96304380E+02*bob;
                A = [a7 a6 a5 a4 a3 a2 a1 a0];
                MagnetType = 'quad';
