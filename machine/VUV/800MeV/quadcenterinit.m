...
if QMS.QuadPlane==1        
    ...
    % For bipolar case:
    % QuadDelta will be +/- QuadDelta 
    % CorrDelta will be +/- CorrDelta
    if strcmp(QMS.QuadFamily,'QD')==1 | strcmp(QMS.QuadFamily,'QDT')==1
        QMS.QuadDelta = 3.0; QMS.CorrDelta = 1.0;
    else
...
elseif QMS.QuadPlane==2       
    ...
    % CorrDelta will be +/- CorrDelta
    if strcmp(QMS.QuadFamily,'QD')==1 | strcmp(QMS.QuadFamily,'QDT')==1
        QMS.QuadDelta = 1.0; QMS.CorrDelta = 1.0;
    else
        error('QuadFamily error.');
    end
else
