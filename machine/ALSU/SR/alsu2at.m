function [k, B] = solaris2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%SOLARIS2AT - Converts control system values to the AT simulator values
%  [K, B] = solaris2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%
%  INPUTS
%  1. Family - Family name
%  2. Field - Sub-field (like 'Setpoint')
%  3. Value - Control system value
...
%
%  See also at2solaris, hw2physics, physics2hw
