function [Value, B] = at2solaris(Family, Field, k, DeviceList, Energy, BranchFlag)
%AT2SOLARIS - Converts the AT simulator values to control system values
%  [Value, B] = at2solaris(Family, Field, K, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%
%  See also solaris2at, hw2physics, physics2hw
