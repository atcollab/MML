...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
FileNameAttn = bpm_meas_staticgain(AFE, Rev, 'Test:BPM1');
...
save(FileName, 'AFE', 'DFE', 'FileName', 'FileNameAttn', 'IP', 'ENV', 'ADC', 'SA', 'x', 'y', 's', 'a', 'b', 'c', 'd', 'attn');
