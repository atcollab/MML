...
if strcmpi(getfamilydata('Machine'), 'APEX')
    ...
    CamList = {
        ...
        'Screen 1 Camera (SCam1)',        'SCam1',    'Screen1:Command'
        'Emit. Meas. Slit 1 (EMCam1)',    'EMCam1',   ''
        'Screen 2 Camera (SCam2)',        'SCam2',    'Screen2:Command'
        'Screen 3 Camera (SCam3)',        'SCam3',    'Screen3:Command'
        'Spectrometer Camera (SpecCam1)', 'SpecCam1', 'Screen4:Command'
        'UED Screen 1 Camera (UCam1)',    'UCam1',    'Screen1:Command'
        'UED Screen 2 Camera (UCam2)',    'UCam2',    'Screen1:Command'
        'UED EX 1 Camera (UEXCam1)',      'UEXCam1',  'Screen1:Command'
        };
    % GC1380H
    Nrows = 1024;
    Ncols = 1360;
...
if get(handles.Camera_PassiveSelect, 'Value') == 1
    ...
    if isempty(CamActive)
        % Is nothing is active, default to None
        CamName = 'None';
        CamValue = 1;
    end
