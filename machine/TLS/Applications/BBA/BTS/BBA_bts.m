...
%
%      BBA_bts('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BBA_bts.M with the given input arguments.
%
%      BBA_bts('Property','Value',...) creates a new BBA_bts or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before BBA_bts_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to BBA_bts_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help BBA_bts

% Last Modified by GUIDE v2.5 30-Apr-2012 16:38:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BBA_bts_OpeningFcn, ...
                   'gui_OutputFcn',  @BBA_bts_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before BBA_bts is made visible.
function BBA_bts_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to BBA_bts (see VARARGIN)

% Choose default command line output for BBA_bts
...
function varargout = BBA_bts_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in QM.
function QM_Callback(hObject, eventdata, handles)
% hObject    handle to QM (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of QM
...
DL13 = get(handles.DL13, 'Value');
DL14 = get(handles.DL14, 'Value');
DL15 = get(handles.DL15, 'Value');
DL16 = get(handles.DL16, 'Value');
DL17 = get(handles.DL17, 'Value');
if DL1 == 1
...
if DL3 == 1
    QuadDev = cat(1,QuadDev,[1 3]);
end
if DL4 == 1
    QuadDev = cat(1,QuadDev,[1 4]);
end
if DL5 == 1
    QuadDev = cat(1,QuadDev,[1 5]);
end
if DL6 == 1
    QuadDev = cat(1,QuadDev,[1 6]);
end
if DL7 == 1
    QuadDev = cat(1,QuadDev,[1 7]);
end
if DL8 == 1
    QuadDev = cat(1,QuadDev,[1 8]);
end
if DL9 == 1
    QuadDev = cat(1,QuadDev,[1 9]);
end
if DL10 == 1
    QuadDev = cat(1,QuadDev,[1 10]);
end
if DL11 == 1
    QuadDev = cat(1,QuadDev,[1 11]);
end
if DL12 == 1
    QuadDev = cat(1,QuadDev,[1 12]);
end
if DL13 == 1
    QuadDev = cat(1,QuadDev,[1 13]);
end
if DL14 == 1
    QuadDev = cat(1,QuadDev,[1 14]);
end
if DL15 == 1
    QuadDev = cat(1,QuadDev,[1 15]);
end
if DL16 == 1
    QuadDev = cat(1,QuadDev,[1 16]);
end
if DL17 == 1
    QuadDev = cat(1,QuadDev,[1 17]);
end
Q1 = get(handles.QM, 'Value');
if Q1 == 1
    for i = 1:size(QuadDev,1)
        [QMS1, QMS2] = Qcenter('QM', QuadDev(i,:), XYPlane, 0, handles);
    end
end
...
set(handles.DL13, 'Value', 1);
set(handles.DL14, 'Value', 1);
set(handles.DL15, 'Value', 1);
set(handles.DL16, 'Value', 1);
set(handles.DL17, 'Value', 1);
...
set(handles.DL13, 'Value', 0);
set(handles.DL14, 'Value', 0);
set(handles.DL15, 'Value', 0);
set(handles.DL16, 'Value', 0);
set(handles.DL17, 'Value', 0);
...
%             Delay(ExtraDelay);
    ...
    if isempty(DataList3)
        ...
        DataList3 = strvcat(DataList3,FileName);
...
if QMS.QuadPlane==1        
    ...
    [TmpFamily, QMS.BPMDev, SPosition, PhaseAdvance] = quad2bpm_tl(QMS.QuadFamily, QMS.QuadDev);
...
% --- Executes on button press in DL13.
function DL13_Callback(hObject, eventdata, handles)
% hObject    handle to DL13 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of DL13


% --- Executes on button press in DL14.
function DL14_Callback(hObject, eventdata, handles)
% hObject    handle to DL14 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of DL14


% --- Executes on button press in DL17.
function DL17_Callback(hObject, eventdata, handles)
% hObject    handle to DL17 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of DL17


% --- Executes on button press in DL16.
function DL16_Callback(hObject, eventdata, handles)
% hObject    handle to DL16 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of DL16


% --- Executes on button press in DL15.
function DL15_Callback(hObject, eventdata, handles)
% hObject    handle to DL15 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of DL15

function [BPMFamilyOutput, BPMDevOutput, DeltaSpos, PhaseAdvanceX, PhaseAdvanceY] = quad2bpm_tl(QUADFamily, QUADDev, LocationFlag)
...
%             i = find(abs(BPMspos-QUADspos)==min(abs(BPMspos-QUADspos)) & BPMspos>QUADspos);
            i = min(find((BPMspos-QUADspos) & (BPMspos-QUADspos)>0));
...
function Delay(time)
if strcmpi(getmode('BPMx'),'Simulator')
    sleep(time);
else
    check = ctl_readin('rcinjstr');
    while ~check
        check = ctl_readin('rcinjstr');
        sleep(0.1);
    end
