function Gap = U5_HW(Angle,Index)
Energy = getenergy;
Brho = getbrho(Energy);
...
for i = 1:75
    if i < 3
        if Index == U5PEA(i) 
            Angle = Angle / 0.309 / 0.005 * Brho / 56 * 916;
            break;
        elseif Index == U5PEB(i)
            Angle = Angle / 0.809 / 0.005 * Brho / 56 * 916;
            break;
        elseif Index == U5PEC(i)
            Angle = Angle / 0.0025 * Brho / 56 * 916;
            break;
        ...
        elseif Index == U5P1A(i)
            Angle = Angle / 0.309 / 0.005 * Brho / 32 * 61;
            break;
        elseif Index == U5P1B(i)
            Angle = Angle / 0.809 / 0.005 * Brho / 32 * 61;
            break;
        elseif Index == U5P1C(i)
            Angle = Angle / 0.0025 * Brho / 32 * 61;
            break;
        ...
        elseif Index == U5P2A(i)
            Angle = Angle / 0.309 / 0.005 * Brho / 58 * 61;
            break;
        elseif Index == U5P2B(i)
            Angle = Angle / 0.809 / 0.005 * Brho / 58 * 61;
            break;
        elseif Index == U5P2C(i)
            Angle = Angle / 0.0025 * Brho / 58 * 61;
            break;
    ...
    if (Index == U5PNA(i).A || Index == U5PNA(i).B)
        Angle = Angle / 0.309 / 0.005 * Brho;
        break;
    elseif (Index == U5PNB(i).A || Index == U5PNB(i).B)
        Angle = Angle / 0.809 / 0.005 * Brho;
        break;
    elseif (Index == U5PNC(i).A || Index == U5PNC(i).B)
        Angle = Angle / 0.0025 * Brho;
        break;
...
Gap = interp1(U5.PeakField,U5.Parameter,Angle,'linear');
return
