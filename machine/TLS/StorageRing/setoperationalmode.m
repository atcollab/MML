...
%
%  ModeNumber = 1. 1.5 GeV, User Mode {Default}
%               2. 1.5 GeV, Model
...
MMLROOT = getmmlroot;
AD.Directory.Orbit    = [MMLROOT, 'machine', filesep, 'TLS', filesep, 'Applications', filesep, 'orbit',    filesep, 'tls'];
