function Amps = SW6_HW(Angle,Index)
Energy = getenergy;
Brho = getbrho(Energy);
...
for i = 1:14
    if i < 3
        if Index == SW6PEA(i) 
            Angle = Angle / 0.309 / 0.006 * Brho / (57/448);
            break;
        elseif Index == SW6PEB(i)
            Angle = Angle / 0.809 / 0.006 * Brho / (57/448);
            break;
        elseif Index == SW6PEC(i)
            Angle = Angle / 0.003 * Brho / (57/448);
            break;
        ...
        elseif Index == SW6P2A(i)
            Angle = Angle / 0.309 / 0.006 * Brho / (270/448);
            break;
        elseif Index == SW6P2B(i)
            Angle = Angle / 0.809 / 0.006 * Brho / (270/448);
            break;
        elseif Index == SW6P2C(i)
            Angle = Angle / 0.003 * Brho / (270/448);
            break;
    ...
    if (Index == SW6PA(i).A || Index == SW6PA(i).B)
        Angle = Angle / 0.309 / 0.006 * Brho;
        break;
    elseif (Index == SW6PB(i).A || Index == SW6PB(i).B)
        Angle = Angle / 0.809 / 0.006 * Brho;
        break;
    elseif (Index == SW6PC(i).A || Index == SW6PC(i).B)
        Angle = Angle / 0.003 * Brho;
        break;
...
Amps = interp1(SW6.PeakField,SW6.Parameter,Angle,'linear');
return
