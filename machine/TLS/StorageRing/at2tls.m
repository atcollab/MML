...
if any(strcmpi(Field, {'Setpoint','Monitor'}))
    ...
    elseif strcmpi(Family, 'BEND')
        ...
        A = A / 1000;
        Brho = getbrho(Energy);
        Amps = interp1(C,A,-k*Brho*1.22); % Unit = KAmps
        return
    ...
    elseif strcmpi(Family, 'QD1')
        ...
        Brho = getbrho(Energy);
        BLeff = -k * Brho * 0.35;
        Amps = interp1(QD1.B1L,QD1.PS,BLeff);
        return
    ...
    elseif strcmpi(Family, 'QF1')
        ...
        Brho = getbrho(Energy);
        BLeff = -k * Brho * 0.35;
        Amps = interp1(QF1.B1L,QF1.PS,BLeff);
        return
    ...
    elseif strcmpi(Family, 'QD2')
        ...
        Brho = getbrho(Energy);
        BLeff = -k * Brho * 0.24;
        Amps = interp1(QD2.B1L,QD2.PS,BLeff);
        return
    ...
    elseif strcmpi(Family, 'QF2')
        ...
        Brho = getbrho(Energy);
        BLeff = -k * Brho * 0.35;
        Amps = interp1(QF2.B1L,QF2.PS,BLeff);
        return
    ...
    elseif strcmpi(Family, 'SD')
        ...
        Brho = getbrho(Energy);
        BLeff = -k * Brho * 0.06 * 2;
        Amps = interp1(SD.B2L,SD.PS,BLeff);
        return
    ...
    elseif strcmpi(Family, 'SF')
        ...
        Brho = getbrho(Energy);
        BLeff = k * Brho * 0.06 * 2;
        Amps = interp1(SF.B2L,SF.PS,BLeff);
        return
    ...
    elseif strcmpi(Family, 'SWLS')
        ...
        for i = 1: size(DeviceList,1)
            ...
            Amps(i,1) = SWLS_HW(k(i,1),AT.ATIndex(Index));
        end
        return
    ...
    elseif strcmpi(Family, 'IASW6')
        ...
        for i = 1: size(DeviceList,1)
            Index = DeviceList(i,2);
            Amps(i,1) = IASW6_HW(k(i,1),AT.ATIndex(Index));
        end
        return
    ...
    elseif strcmpi(Family, 'W20')
        ...
        for i = 1: size(DeviceList,1)
            Index = DeviceList(i,2);
            Amps(i,1) = W20_HW(k(i,1),AT.ATIndex(Index));
        end
        return
    ...
    elseif strcmpi(Family, 'SW6')
        ...
        for i = 1: size(DeviceList,1)
            Index = DeviceList(i,2);
            Amps(i,1) = SW6_HW(k(i,1),AT.ATIndex(Index));
        end
        return
    ...
    elseif strcmpi(Family, 'U9')
        ...
        for i = 1: size(DeviceList,1)
            Index = DeviceList(i,2);
            Amps(i,1) = U9_HW(k(i,1),AT.ATIndex(Index));
        end
        return
    ...
    elseif strcmpi(Family, 'U5')
        ...
        for i = 1: size(DeviceList,1)
            Index = DeviceList(i,2);
            Amps(i,1) = U5_HW(k(i,1),AT.ATIndex(Index));
        end
        return
    ...
    elseif strcmpi(Family, 'EPU56')
        ...
        for i = 1: size(DeviceList,1)
            Index = DeviceList(i,2);
            Amps(i,1) = EPU56_HW(k(i,1),AT.ATIndex(Index));
        end
        return
    ...
    elseif strcmpi(Family, 'IASWB')
        ...
        for i = 1: size(DeviceList,1)
            Index = DeviceList(i,2);
            Amps(i,1) = IASWB_HW(k(i,1),AT.ATIndex(Index));
        end
        return
    ...
    elseif strcmpi(Family, 'IASWC')
        ...
        for i = 1: size(DeviceList,1)
            Index = DeviceList(i,2);
            Amps(i,1) = IASWC_HW(k(i,1),AT.ATIndex(Index));
        end
        return
