...
for i = 1:24
    if i < 5
        if Index == W20P1A(i) 
            Angle = W20ABC22p5P1(1);
            break;
        elseif Index == W20P1B(i)
            Angle = W20ABC22p5P1(2);
            break;
        elseif Index == W20P1C(i)
            Angle = W20ABC22p5P1(3);
            break;
        elseif Index == W20P2A(i)
            Angle = W20ABC22p5P2(1);
            break;
        elseif Index == W20P2B(i)
            Angle = W20ABC22p5P2(2);
            break;
        elseif Index == W20P2C(i)
            Angle = W20ABC22p5P2(3);
            break;
        end
    end
     
    if Index == W20PXA(i)
        Angle = W20ABC22p5PX(1);
        break;
    elseif Index == W20PXB(i)
        Angle = W20ABC22p5PX(2);
        break;
    elseif Index == W20PXC(i)
        Angle = W20ABC22p5PX(3);
        break;
    end
     
    if i < 23
        if Index == W20PCA(i) 
            Angle = W20ABC22p5PC(1);
            break;
        elseif Index == W20PCB(i) 
            Angle = W20ABC22p5PC(2);
            break;
        elseif Index == W20PCC(i) 
            Angle = W20ABC22p5PC(3);
            break;
        end
    end
