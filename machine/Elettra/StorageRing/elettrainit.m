...
% Remove bpm_S7.6 because used for RF cavity
% i = findrowindex([7 6], EightPerSectorList);
% EightPerSectorList = [EightPerSectorList(1:i-1,:); EightPerSectorList(i+1:end,:)];

% Remove correctors in sector 12 for the injection
i = findrowindex([12 3], SevenPerSectorList);
SevenPerSectorList = [SevenPerSectorList(1:i-1,:); SevenPerSectorList(i+1:end,:)];
i = findrowindex([12 4], SevenPerSectorList);
SevenPerSectorList = [SevenPerSectorList(1:i-1,:); SevenPerSectorList(i+1:end,:)];

% Add ottavo corrector in sector 6-11
i = findrowindex([6 7], SevenPerSectorList);
SevenPerSectorList = [SevenPerSectorList(1:i,:); [6 8]; SevenPerSectorList(i+1:end,:)];
i = findrowindex([11 7], SevenPerSectorList);
SevenPerSectorList = [SevenPerSectorList(1:i,:); [11 8]; SevenPerSectorList(i+1:end,:)];
...
AO.BPMx.Monitor.TangoNames = getname_elettra('BPMx', 'Monitor', AO.BPMx.DeviceList);
...
AO.BPMy.Monitor.TangoNames = getname_elettra('BPMy', 'Monitor', AO.BPMy.DeviceList);
...
AO.HCM.Monitor.TangoNames = getname_elettra('HCM', 'Monitor', AO.HCM.DeviceList);
...
AO.HCM.Setpoint.TangoNames = getname_elettra('HCM', 'Setpoint', AO.HCM.DeviceList);
...
AO.VCM.Monitor.TangoNames = getname_elettra('VCM', 'Monitor', AO.VCM.DeviceList);
...
AO.VCM.Setpoint.TangoNames = getname_elettra('VCM', 'Setpoint', AO.VCM.DeviceList);
...
AO.QF.Monitor.TangoNames = getname_elettra('QF', 'Monitor', AO.QF.DeviceList);
...
AO.QF.Setpoint.TangoNames = getname_elettra('QF', 'Setpoint', AO.QF.DeviceList);
...
AO.QD.Monitor.TangoNames = getname_elettra('QD', 'Monitor', AO.QD.DeviceList);
...
AO.QD.Setpoint.TangoNames = getname_elettra('QD', 'Setpoint', AO.QD.DeviceList);
...
AO.Q1.Monitor.TangoNames = getname_elettra('Q1', 'Monitor', AO.Q1.DeviceList);
...
AO.Q1.Setpoint.TangoNames = getname_elettra('Q1', 'Setpoint', AO.Q1.DeviceList);
...
AO.Q2.Monitor.TangoNames = getname_elettra('Q2', 'Monitor', AO.Q2.DeviceList);
...
AO.Q2.Setpoint.TangoNames = getname_elettra('Q2', 'Setpoint', AO.Q2.DeviceList);
...
AO.Q3.Monitor.TangoNames = getname_elettra('Q3', 'Monitor', AO.Q3.DeviceList);
...
AO.Q3.Setpoint.TangoNames = getname_elettra('Q3', 'Setpoint', AO.Q3.DeviceList);
...
AO.SF.Monitor.TangoNames = getname_elettra('SF', 'Monitor', AO.SF.DeviceList);
...
AO.SF.Setpoint.TangoNames = getname_elettra('SF', 'Setpoint', AO.SF.DeviceList);
...
AO.SD.Monitor.TangoNames = getname_elettra('SD', 'Monitor', AO.SD.DeviceList);
...
AO.SD.Setpoint.TangoNames = getname_elettra('SD', 'Setpoint', AO.SD.DeviceList);
...
AO.S1.FamilyName = 'S1';
AO.S1.MemberOf   = {'PlotFamily'; 'S1'; 'SEXT'; 'Magnet'};
...
AO.S1.Monitor.TangoNames = getname_elettra('S1', 'Monitor', AO.S1.DeviceList);
...
AO.S1.Setpoint.TangoNames = getname_elettra('S1', 'Setpoint', AO.S1.DeviceList);
...
AO.BEND.Monitor.TangoNames(:,:) = getname_elettra('BEND', 'Monitor', AO.BEND.DeviceList);
...
AO.BEND.Setpoint.TangoNames(:,:) = getname_elettra('BEND', 'Setpoint', AO.BEND.DeviceList);
...
AO.RF.Monitor.TangoNames = getname_elettra('RF', 'Monitor', AO.RF.DeviceList);
...
AO.RF.Setpoint.TangoNames = getname_elettra('RF', 'Setpoint', AO.RF.DeviceList);
...
AO.DCCT.Monitor.TangoNames = getname_elettra('DCCT', 'Monitor', AO.DCCT.DeviceList);
...
AO.S1.Setpoint.DeltaRespMat  = 1e-4;
