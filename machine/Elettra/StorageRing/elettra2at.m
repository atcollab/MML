function k = elettra2at(Family, Field, Amps, DeviceList, Energy)
%ELETRA2AT - Converts amperes to simulator values
%  K = elettra2at(Family, Field, Amps, DeviceList, Energy)
%
%  INPUTS
...
%
%  See also at2elettra, hw2physics, physics2hw
