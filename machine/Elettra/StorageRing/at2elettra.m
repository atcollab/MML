function Amps = at2elettra(Family, Field, k, DeviceList, Energy)
%AT2ELETTRA - Converts simulator values to amperes
%  Amps = at2elettra(Family, Field, K, DeviceList, Energy)
%
%  INPUTS
...
%
%  See also elettra2at, hw2physics, physics2hw
