...
try
    ...
    AO.CQS.AT.ATIndex = buildatindex(AO.CQS.FamilyName, Indices.SF([2 3 6 7]));
...
try
    ...
    % S3
    AO.HSD.AT.ATType = 'SEXT';
    AO.HSD.AT.ATIndex = buildatindex(AO.HSD.FamilyName, Indices.HSD);
    AO.HSD.Position = findspos(THERING, AO.HSD.AT.ATIndex(:,1))';
catch
