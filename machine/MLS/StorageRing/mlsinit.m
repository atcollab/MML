...
% 4. I split the S1, S2, S3 families so that correctors can be put in the middle.
...
% 7. I put all the QF, QD, etc. magnets in one family.  This can be changed
...
% 8. If you are not already doing it, I would recommend using LabCA!!!
% 9. If you want to use SF, SD, HSD instead of S1, S2, S3 use the file in 
%    ...\StorageRing\SF-SD_files
...
AO.S1.DeviceList  = cell2mat(S1cell(:,5));
AO.S1.ElementList = (1:size(AO.S1.DeviceList,1))';  %cell2mat(S1cell(:,6));
AO.S1.Status      = cell2mat(S1cell(:,4));
AO.S1.Position    = cell2mat(S1cell(:,7));
AO.S1.CommonNames = cell2mat(S1cell(:,1));

AO.S1.Monitor.MemberOf = {};
AO.S1.Monitor.Mode = 'Simulator';
AO.S1.Monitor.DataType = 'Scalar';
AO.S1.Monitor.ChannelNames = cell2mat(S1cell(:,2));
AO.S1.Monitor.HW2PhysicsFcn = @mls2at;
AO.S1.Monitor.Physics2HWFcn = @at2mls;
...
AO.S1.Setpoint.ChannelNames = cell2mat(S1cell(:,3));
AO.S1.Setpoint.HW2PhysicsFcn = @mls2at;
AO.S1.Setpoint.Physics2HWFcn = @at2mls;
AO.S1.Setpoint.Units        = 'Hardware';
AO.S1.Setpoint.HWUnits      = 'Ampere';
AO.S1.Setpoint.PhysicsUnits = 'meter^-3';
AO.S1.Setpoint.Range = cell2mat(S1cell(:,8));
AO.S1.Setpoint.Tolerance = cell2mat(S1cell(:,9));
AO.S1.Setpoint.DeltaRespMat = cell2mat(S1cell(:,10));
...
AO.S2.DeviceList  = cell2mat(S2cell(:,5));
AO.S2.ElementList = (1:size(AO.S2.DeviceList,1))';  %cell2mat(S2cell(:,6));
AO.S2.Status      = cell2mat(S2cell(:,4));
AO.S2.Position    = cell2mat(S2cell(:,7));
AO.S2.CommonNames = cell2mat(S2cell(:,1));

AO.S2.Monitor.MemberOf = {};
AO.S2.Monitor.Mode = 'Simulator';
AO.S2.Monitor.DataType = 'Scalar';
AO.S2.Monitor.ChannelNames = cell2mat(S2cell(:,2));
AO.S2.Monitor.HW2PhysicsFcn = @mls2at;
AO.S2.Monitor.Physics2HWFcn = @at2mls;
...
AO.S2.Setpoint.ChannelNames = cell2mat(S2cell(:,3));
AO.S2.Setpoint.HW2PhysicsFcn = @mls2at;
AO.S2.Setpoint.Physics2HWFcn = @at2mls;
AO.S2.Setpoint.Units        = 'Hardware';
AO.S2.Setpoint.HWUnits      = 'Ampere';
AO.S2.Setpoint.PhysicsUnits = 'meter^-3';
AO.S2.Setpoint.Range = cell2mat(S2cell(:,8));
AO.S2.Setpoint.Tolerance = cell2mat(S2cell(:,9));
AO.S2.Setpoint.DeltaRespMat = cell2mat(S2cell(:,10));
...
AO.S3.DeviceList  = cell2mat(S3cell(:,5));
AO.S3.ElementList = (1:size(AO.S3.DeviceList,1))';  %cell2mat(S3cell(:,6));
AO.S3.Status      = cell2mat(S3cell(:,4));
AO.S3.Position    = cell2mat(S3cell(:,7));
AO.S3.CommonNames = cell2mat(S3cell(:,1));

AO.S3.Monitor.MemberOf = {};
AO.S3.Monitor.Mode = 'Simulator';
AO.S3.Monitor.DataType = 'Scalar';
AO.S3.Monitor.ChannelNames = cell2mat(S3cell(:,2));
AO.S3.Monitor.HW2PhysicsFcn = @mls2at;
AO.S3.Monitor.Physics2HWFcn = @at2mls;
...
AO.S3.Setpoint.ChannelNames = cell2mat(S3cell(:,3));
AO.S3.Setpoint.HW2PhysicsFcn = @mls2at;
AO.S3.Setpoint.Physics2HWFcn = @at2mls;
AO.S3.Setpoint.Units        = 'Hardware';
AO.S3.Setpoint.HWUnits      = 'Ampere';
AO.S3.Setpoint.PhysicsUnits = 'meter^-3';
AO.S3.Setpoint.Range = cell2mat(S3cell(:,8));
AO.S3.Setpoint.Tolerance = cell2mat(S3cell(:,9));
AO.S3.Setpoint.DeltaRespMat = cell2mat(S3cell(:,10));
