function [x, y, ygoal, xtotal] = xraylocofit(funfcn, x0, ygoal)
% [x, y, ygoal, xtotal] = xraylocofit(funfcn, x0, ygoal)
%


% Needs work for the xray ring 
...
%
%  Also see setlocogains alsfitnuy9
%
