...
% Compiled from spear3 TRACY deck from Corbett 11/22/99 
% Simplified SPEAR-III lattice
...
disp(' ');
disp('** Loading SPEAR-III lattice in SPEAR.m **');
AP   =  aperture('AP',  [-0.05, 0.05, -0.05, 0.05],'AperturePass');
KICK =  corrector('KICK',0.6,[0.0 0.0],'CorrectorPass');
KICK1 = corrector('KICK1',1.2,[0.0 0.0],'CorrectorPass');
KICK2 = corrector('KICK2',0.6,[0.0 0.0],'CorrectorPass');
KICK3 = corrector('KICK3',1.2,[0.0 0.0],'CorrectorPass');

COR =   corrector('COR',0.1,[0 0],'CorrectorPass');
...
QFC	=	quadrupole('QFC' , 0.25, 1.786614951331,'QuadLinearPass');
...
%SD		=	sext('SD' , 0.25,0,'StrThickMPole4thOrderPass');
%SF		=	sext('SF'  , 0.21, 0,'StrThickMPole4thOrderPass');
