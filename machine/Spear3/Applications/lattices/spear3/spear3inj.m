...
K1 =  corrector('K1',1.2,[0 0],'CorrectorPass');
K2 =  corrector('K2',0.6,[0 0],'CorrectorPass');
K3 =  corrector('K3',1.2,[0 0],'CorrectorPass');
...
NORTH  = [ACELK1 K1 ACELK2 K2 BPM ACELK3 K3...
