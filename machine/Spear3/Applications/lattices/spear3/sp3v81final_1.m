...
QF		=	quadrupole('QF' , 0.34, 1.832997150712, 'StrMPoleSymplectic4Pass');
QD		=	quadrupole('QD' , 0.15,-1.66658541192, 'StrMPoleSymplectic4Pass');
QFC	    =	quadrupole('QFC', 0.5,  1.788658526294, 'StrMPoleSymplectic4Pass');

%Standard Cell Sextupoles
SF		=	sextupole('SF' , 0.21, 32.090657930714/2,'StrMPoleSymplectic4Pass');
SD		=	sextupole('SD' , 0.25,-38.865860156183/2,'StrMPoleSymplectic4Pass');
...
DM4	    =	drift('DM4' ,0.22254047,'DriftPass');
...
DA1B	=	drift('DA1B' ,0.1307614,'DriftPass');
DA3A	=	drift('DA3A' ,0.2141648,'DriftPass');
DA3B	=	drift('DA3B' ,0.0608352,'DriftPass');
...
DA7B	=	drift('DA7B' ,0.0693034,'DriftPass');
...
DB1B	=	drift('DB1B' ,0.062918 ,'DriftPass');
...
DB9A	=	drift('DB9A' ,0.13000000000000,'DriftPass');
DB9B	=	drift('DB9B' ,0.13000000000000,'DriftPass');
...
QDX 	=	quadrupole('QDX' ,0.34,-1.439166430718 , 'StrMPoleSymplectic4Pass');
QFX 	=	quadrupole('QFX' ,0.6,  1.592000165613 , 'StrMPoleSymplectic4Pass');
QDY 	=	quadrupole('QDY' ,0.34,-0.460640930646 , 'StrMPoleSymplectic4Pass');
QFY 	=	quadrupole('QFY' ,0.5,  1.515818817204 , 'StrMPoleSymplectic4Pass');
QDZ 	=	quadrupole('QDZ' ,0.34,-0.909127908882 , 'StrMPoleSymplectic4Pass');
QFZ 	=	quadrupole('QFZ' ,0.34, 1.47951298778 , 'StrMPoleSymplectic4Pass');
