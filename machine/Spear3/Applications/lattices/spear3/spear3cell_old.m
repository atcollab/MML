...
BND	=	rbend('BND'  , 1.452065,  ...
           ...
           -0.33,'BendLinearPass');
BND1	=	rbend('BND'  , 1.452065*0.14,  ...
            0.18479957*0.14, 0.18479957/2, 0.0,...
           -0.33,'BendLinearPass');
BND2	=	rbend('BND'  , 1.452065*.86,  ...
            0.18479957*.86, 0.0, 0.18479957/2,...
           -0.33,'BendLinearPass');
...
% Begin Lattice
%**** NOTE: QFC NOT SPLIT
HCEL1 =	[DC1 BPM QF DC2 COR DC2 QD DC3 BND1 BND2 BPM DC4 SD...
