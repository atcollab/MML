...
MCA=[BPM DA1B QDX DA2A COR DA2B ...
...
MCB=[BPM DB1B QDX DB2A COR DB2B ...
...
% Triplet Section
D9A   =	drift('D9A'     ,2.8504   ,'DriftPass');   %different than D9A in sp3v81fdw
D9B   =	drift('D9B'     ,0.23805,'DriftPass');
D9C   =	drift('D9C'     ,2.7825  ,'DriftPass');
QF9_1 	=	quadrupole('QDW'  ,0.3533895, 0.0,  'QuadLinearPass');
QD9_1 	=	quadrupole('QDW'  ,0.6105311, 0.0 , 'QuadLinearPass');
QF9_2 	=	quadrupole('QDW'  ,0.3533895, 0.0,  'QuadLinearPass');
S09=[D9A QF9_1 D9B QD9_1 D9B QF9_2 D9C];
        
% Begin Lattice
NORTH	=	[CEL2 CEL3 CEL4 CEL5 ACEL ACEL ACEL];
SOUTH	=	[ACEL ACEL ACEL ACEL ACEL ACEL ACEL];
ELIST	=	[CAV MCAWEST NORTH reverse(MCB) S09 MCA SOUTH reverse(MCBWEST)]; 
buildlat(ELIST);
