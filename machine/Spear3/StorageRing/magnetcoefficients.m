...
factor = 1.0; %10.00692271077745;  %factor to agree with J. Tanabe plots
c8 = 0 * factor;
c7 = 0 * factor;
c6 = a5/(i0^5) * factor;
c5 = a4/(i0^4) * factor;
...
c0 = 0 * factor;
MagnetType = 'bend';
Leff=1;   %measured data are in Tesla-m

        
        case 'CD2'    %chicane dipole #2
a0=7.3037E-04;
a1=2.0016E-06;
a2=-7.7885E-08;
a3=1.0709E-09;
