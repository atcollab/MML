...
DP1   =    drift('DP1'  , 1,'DriftPass');
MDP1   =   drift('MDP1' ,-1,'DriftPass');

DP =  [DP1  DP1  DP1  DP1  DP1  DP1  DP1  DP1  DP1  DP1 ];
MDP = [MDP1 MDP1 MDP1 MDP1 MDP1 MDP1 MDP1 MDP1 MDP1 MDP1];
