...
QF		=	quadrupole('QF' , 0.3533895, 1.756549028074, 'QuadLinearPass');
QD		=	quadrupole('QD' , 0.1634591,-1.481426221173, 'QuadLinearPass');
QFC	    =	quadrupole('QFC', 0.5123803, 1.748639817873, 'QuadLinearPass');

%Standard Cell Sextupoles
SF		=	sextupole('SF' , 0.21, 32.631291027666/2,'StrMPoleSymplectic4Pass');
SD		=	sextupole('SD' , 0.25,-39.583336103319/2,  'StrMPoleSymplectic4Pass');
...
QDX 	=	quadrupole('QDX' ,0.3533895,-1.609741351419 , 'QuadLinearPass');
QFX 	=	quadrupole('QFX' ,0.6105311,1.756178092841, 'QuadLinearPass');
QDY 	=	quadrupole('QDY' ,0.3533895,-0.881764822 , 'QuadLinearPass');
QFY 	=	quadrupole('QFY' ,0.5123803, 1.481513574878 , 'QuadLinearPass');
QDZ 	=	quadrupole('QDZ' ,0.3533895,-0.747669311378 , 'QuadLinearPass');
QFZ 	=	quadrupole('QFZ' ,0.3533895, 1.379581282637 , 'QuadLinearPass');
