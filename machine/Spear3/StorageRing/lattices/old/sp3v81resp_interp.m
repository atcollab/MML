...
DC1A   =    drift('DC1A' ,0.3,'DriftPass');
DC1B   =    drift('DC1B' ,0.036670,'DriftPass');
DC1    =    [DC1A DC1A DC1A DC1A DC1A DC1B];
...
DM1A	=	drift('DM1' ,0.6000000,'DriftPass');
DM1B	=	drift('DM1' ,0.21000000,'DriftPass');
DM1     =  [DM1A DM1A DM1A DM1A DM1A DM1A DM1B];
...
DM10A=	drift('DM10',0.50000000,'DriftPass');
DM10B=	drift('DM10',0.27657140,'DriftPass');
DM10     =  [DM10A DM10A DM10A DM10A DM10A DM10A DM10B];
