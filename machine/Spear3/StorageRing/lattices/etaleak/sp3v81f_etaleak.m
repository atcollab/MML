...
QF		=	quadrupole('QF' , 0.3533895, 1.80690158, 'QuadLinearPass');
QD		=	quadrupole('QD' , 0.1634591,-1.54808723, 'QuadLinearPass');
QFC	    =	quadrupole('QFC', 0.5123803, 1.685665715, 'QuadLinearPass');

%Standard Cell Sextupoles
SF		=	sextupole('SF' , 0.21, 33.5/2,'StrMPoleSymplectic4Pass');
SD		=	sextupole('SD' , 0.25,-40.7/2,  'StrMPoleSymplectic4Pass');
...
QDX 	=	quadrupole('QDX' ,0.3533895,-1.3421524 , 'QuadLinearPass');
QFX 	=	quadrupole('QFX' ,0.6105311,1.623233438, 'QuadLinearPass');
QDY 	=	quadrupole('QDY' ,0.3533895,-0.606749668 , 'QuadLinearPass');
QFY 	=	quadrupole('QFY' ,0.5123803,  1.41473955 , 'QuadLinearPass');
QDZ 	=	quadrupole('QDZ' ,0.3533895,-0.82983763 , 'QuadLinearPass');
QFZ 	=	quadrupole('QFZ' ,0.3533895, 1.39838263 , 'QuadLinearPass');
