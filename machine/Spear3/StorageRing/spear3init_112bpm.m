...
'ID05_SQ '  '12S-ID5QS:Curr1  '    '12S-ID5QS:CurrSetpt  '  '12S-ID5QS:CurrReference  '      1  [12,1]  5
'ID04_TH '  '13S-ID4TH:Curr1  '    '13S-ID4TH:CurrSetpt  '  '13S-ID4TH:CurrReference  '      1  [13,2]  6
'ID04_TV '  '13S-ID4TV:Curr1  '    '13S-ID4TV:CurrSetpt  '  '13S-ID4TV:CurrReference  '      1  [13,2]  7
'ID11_TH '  '15S-ID11TH:Curr1 '    '15S-ID11TH:CurrSetpt '  '15S-ID11TH:CurrReference '      1  [15,1]  8
'ID11_TV '  '15S-ID11TV:Curr1 '    '15S-ID11TV:CurrSetpt '  '15S-ID11TV:CurrReference '      1  [15,2]  9
};
...
AO{ifam}.MemberOf                       = {'MachineConfig'; 'Injection'};
...
%   };
kickeramp={ 
 'K1     '    '02S-K1:VoltReadback'     '02S-K1:VoltSetpt'  1   [2  ,1]  1  [0 9]  0.10 ; ...
 'K2     '    '03S-K2:VoltReadback'     '03S-K2:VoltSetpt'  1   [3  ,1]  2  [0 9]  0.10 ; ...
 'K3     '    '04S-K3:VoltReadback'     '04S-K3:VoltSetpt'  1   [4  ,1]  3  [0 9]  0.10 ; ...
  };
