function varargout = plotltbbeamspots(varargin)
% SPOTSIZE = PLOTLTBBEAMSPOTS
%
...
% Eugene Tan  2006-08-21: Modified a little to utilise the new plotltb
...
numscreens = 3;
screennames = {'screen1', 'screen2','screen3'};

for i=1:numscreens
    I_screen(i) = findcells(LTB,'FamName',screennames{i});
end
