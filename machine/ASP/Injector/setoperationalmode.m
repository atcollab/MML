...
AD.SubMachine = 'Injector';       % Will already be defined if setpathmml was used
...
if ModeNumber == 1
    % User mode
    AD.OperationalMode = 'Injector';
    ModeName = 'Commissioning';
    OpsFileExtension = '_Injector';
    ...
    % LTB
    ltb;
    THERINGCELL{1} = THERING;
    
    % BTS
    bts;
    THERINGCELL{3} = THERING;
    
    % Booster
    AD.ATModel = 'asbooster';
    asbooster; 
    disp(' ');
    THERINGCELL{2} = THERING;
