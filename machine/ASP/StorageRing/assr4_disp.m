...
qfa	=	quadrupole('QFA'	,3.550000e-001, 1.77243609624092,'QuadLinearPass');
qda	=	quadrupole('QDA'	,1.800000e-001,-1.08644392034807,'QuadLinearPass');
qfb	=	quadrupole('QFB'	,3.550000e-001, 1.53875745367088,'QuadLinearPass');
...
celrf06_4 = [ bpm1d1RF girder1 newbend girder2 newbend girder3 bpm7d1 ];
celrf07_4 = [ bpm1d1RF girder1 newbend girder2 newbend girder3 bpm7d1 ];
