...
% RBEND
b_left01 = rbend('b_left01',0.0695313,0.00018,0.1121962211,-0.08975979008,0.0026673*scalek,'BndMPoleSymplectic4Pass');
b_left02 = rbend('b_left02',0.0695282,	0.000754,0.08975979008,-0.06731984256,-0.0005343*scalek,'BndMPoleSymplectic4Pass');
b_left03 = rbend('b_left03',0.0695147,	0.0035398,0.06731984256,-0.04487989504,-0.1196811*scalek,'BndMPoleSymplectic4Pass');
b_left04 = rbend('b_left04',0.0694665,	0.0089018,0.04487989504,-0.02243994752,-0.3476808*scalek,'BndMPoleSymplectic4Pass');
b_left05 = rbend('b_left05',0.0694028,	0.0092688,0.02243994752,-0.0,-0.327875*scalek,'BndMPoleSymplectic4Pass');
b_centre01 = rbend('b_centre01',0.2820423,	0.03669755,0.0,-0.0,-0.3310676*scalek,'BndMPoleSymplectic4Pass');
b_centre02 = rbend('b_centre02',0.2815018,	0.035401,0.0,-0.0,-0.3304239*scalek,'BndMPoleSymplectic4Pass');
b_centre03 = rbend('b_centre03',0.2813281,	0.0349136,0.0,0.0,-0.3300984*scalek,'BndMPoleSymplectic4Pass');
b_centre04 = rbend('b_centre04',0.2815018,	0.035401,-0.0,0.0,-0.3304239*scalek,'BndMPoleSymplectic4Pass');
b_centre05 = rbend('b_centatsre05',0.2820423,	0.03669755,-0.0,0.0,-0.3310676*scalek,'BndMPoleSymplectic4Pass');
b_right01 = rbend('b_right01',0.0694028,	0.0092688,-0.0,0.02243994752,-0.327875*scalek,'BndMPoleSymplectic4Pass');
b_right02 = rbend('b_right02',0.0694665,	0.0089018,-0.02243994752,0.04487989504,-0.3476808*scalek,'BndMPoleSymplectic4Pass');
b_right03 = rbend('b_right03',0.0695147,	0.0035398,-0.04487989504,0.06731984256,-0.1196811*scalek,'BndMPoleSymplectic4Pass');
b_right04 = rbend('b_right04',0.0695282,	0.000754,-0.06731984256,0.08975979008,-0.0005343*scalek,'BndMPoleSymplectic4Pass');
b_right05 = rbend('b_right05',0.0695313,	0.00018,-0.08975979008,0.1121997376,0.0026673*scalek,'BndMPoleSymplectic4Pass');

% b_left01 = rbend('b_left01',0.0695312761,0.0001700782,0.1121962211,0,0.0026580668*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 0.0026580668*scalek -0.0222542890 -0.0307698880]);
% b_left02 = rbend('b_left02',0.0695282915,0.0007118132,0.0,-0.0,0.0004302895*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 0.0004302895*scalek -0.0824996146 -0.0652385243]);
% b_left03 = rbend('b_left03',0.0695152451,0.0032678721,0.0,-0.0,-0.1045888695*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.1045888695*scalek -0.0928717833 0.2254072448]);
% b_left04 = rbend('b_left04',0.0694679183,0.0088002187,0.0,-0.0,-0.3486275471*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3486275471*scalek -0.0656081148 0.3572852967]);
% b_left05 = rbend('b_left05',0.0694041758,0.0092692888,0.0,-0.0,-0.3281526271*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3281526271*scalek -0.0355726539 0.3355904266]);
% b_centre01 = rbend('b_centre01',0.2820465390,0.0367531221,0.0,-0.0,-0.3312315118*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3312315118*scalek 0.0081060667 0.2963931827]);
% b_centre02 = rbend('b_centre02',0.2815037989,0.0354072962,0.0,-0.0,-0.3306429237*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3306429237*scalek 0.0237264198 -0.2192733272]);
% b_centre03 = rbend('b_centre03',0.2813281018,0.0349189640,0.0,0.0,-0.3300984023*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3300984023*scalek 0.0101509428 -0.5218382720]);
% b_centre04 = rbend('b_centre04',0.2814996751,0.0353946633,-0.0,0.0,-0.3302048119*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3302048119*scalek 0.0235987043 -0.2144554284]);
% b_centre05 = rbend('b_centre05',0.2820380879,0.0367421699,-0.0,0.0,-0.3309037380*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3309037380*scalek 0.0102169077 0.2963545009]);
% b_right01 = rbend('b_right01',0.0694014448,0.0092683188,-0.0,0.0,-0.3275972520*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3275972520*scalek -0.0308930090 0.3680490900]);
% b_right02 = rbend('b_right02',0.0694650575,0.0090032960,-0.0,0.0,-0.3467634133*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.3467634133*scalek -0.0345063628 0.6218385567]);
% b_right03 = rbend('b_right03',0.0695141539,0.0037116695,-0.0,0.0,-0.1347732139*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.1347732139*scalek 0.0189958278 0.8526578807]);
% b_right04 = rbend('b_right04',0.0695280819,0.0007961566,-0.0,0.0,-0.0014988960*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 -0.0014988960*scalek -0.0849450391 0.2100836063]);
% b_right05 = rbend('b_right05',0.0695312501,0.0001897883,-0.0,0.1121997376,0.0026764692*scalek,'BndMPoleSymplectic4Pass',[0 0 0 0],[0 0.0026764692*scalek -0.0276971797 0.0360627830]);
