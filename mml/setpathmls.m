function [MachineName, SubMachineName, LinkFlag, MMLROOT] = setpathmls(varargin)
%SETPATHMLS - Initializes the Matlab Middle Layer (MML) for MLS
%  [MachineName, SubMachineName, OnlineLinkMethod, MMLROOT] = setpathmls(SubMachineName, OnlineLinkMethod)
%
%  INPUTS
