%MAGSTEP - Script for testing the time responce of a magnet


% BPM Step
BPMxFamily = 'BPMx';
BPMxDevList = [9 7;9 8;9 9;9 10];  %getbpmlist('BPMx'); %[2 1;2 2;2 3;2 4;2 5];
BPMyFamily = 'BPMy';
...
elseif size(BPMxDevList,1) < 10
    ...
    legend(LabelCell, 'Location', 'Best');
end
