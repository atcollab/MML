...
%  2. Same as second column of getfamilydata(Family, Field, 'Range', DeviceList)
%
%  See also minpv, getfamilydata
...
if isempty(Data)
    % Try the .Setpoint range (this maynot be such a good idea)
...
if StructOutputFlag
    ...
    Data.DataDescriptor = sprintf('%s.%s Maximum', Family, Field);
