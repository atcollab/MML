function varargout = addmenuad(h, Command)
%ADDMENUAD - Adds a menu bar to view and edit the MML AD structure
%  addmenuad(handle)
...
switch lower(Command)
    case 'build'
        ...
        if nargin < 3
            LabelString = 'Middle Layer Parameter Setup';
        end
        if nargin < 4
                        ...
                        for k = 1:length(DataStructFieldName3)
                            ...
                            if isstruct(DataStructure3)
                                ...
                                for l = 1:length(DataStructFieldName4)
                                    ...
                                    set(hmenu4,'Callback', 'addmenuad(gcbo,''Action'')');
                                end
                            else
                                ...
                                set(hmenu3,'Callback', 'addmenuad(gcbo,''Action'')');
                            end
                        end
                    else
