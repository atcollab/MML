...
%MACHINE_AT - Returns the optics function as a structure 
...
%  Written by Eugene Tan (28/05/04)
%
%  Change History
%  1. Added export of element names as well 14/11/06
%  2. Added export to xls option. 12/05/05
...
args = 0;
args = args + 1;
if nargin >= args && ~ischar(varargin{args}) && ~isstruct(varargin{args})
