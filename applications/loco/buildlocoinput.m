...
if GuessIt
    ...
    Dxh = getrespmat(BPMxFamily, Rmat(1,1).Monitor.DeviceList, 'RF', [], [DirectoryName DISPFile], 'Struct', 'Hardware', 'NoEnergyScaling');
    ...
    switch ButtonName
        ...
        case 'Get From File'
            ...
            Dxh = getrespmat(BPMxFamily, Rmat(1,1).Monitor.DeviceList, 'RF', [], [DISPDirectory DISPFile], 'Struct', 'Hardware', 'NoEnergyScaling');
...
if isempty(ButtonName)
    ...
    % Note: RF is a setpoint, it should be a monitor.  Future change coming!  GJP
    
    % Dx.ActuatorDelta is a setpoint in measrespmat.  Changing it here to a monitor
