...
void TaylormapPass(double *r_in, double le,
...
#define NUM_COLUMNS 9
{
 ...
 for(c = 0;c<num_particles;c++) {
  ...
  for(i=0;i<npx;i++) {
   tmp = px[i+1*npx];
   for(j=0;j<6;j++) {
    tmp *= pow(rtmp[j], (int)px[i+(j+3)*npx]);
   }
   r6[1] += tmp;
  }
  /* y final */
  ...
  for(i=0;i<npy;i++) {
   tmp = py[i+1*npy];
   for(j=0;j<6;j++) {
    tmp *= pow(rtmp[j], (int)py[i+(j+3)*npy]);
   }
   r6[3] += tmp;
  }
  /* delta E final */
  for(i=0;i<ndelta;i++) {
   ...
   for(j=0;j<6;j++) {
    tmp *= pow(rtmp[j], (int)delta[i+(j+3)*ndelta]);
   }
   r6[4] += tmp;
  }
  /* t final */
...
#define NUM_FIELDS_2_REMEMBER 17
{
 ...
 switch(mode) {
  ...
  case MAKE_LOCAL_COPY: { /* Find field numbers first
   ...
   x = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[1]));
   nx = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[2]));
   px = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[3]));
   npx = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[4]));
   y = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[5]));
   ny = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[6]));
   py = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[7]));
   npy = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[8]));
   delta = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[9]));
   ndelta = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[10]));
   t = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[11]));
   nt = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[12]));
   pt1 = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[13]));
   pt2 = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[14]));
   pr1 = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[15]));
   pr2 = mxGetPr(mxGetFieldByNumber(ElemData,0,NewFieldNumbers[16]));
  ...
  case USE_LOCAL_COPY: { /* Get fields from MATLAB using field numbers
   ...
   x = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[1]));
   nx = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,FieldNumbers[2]));
   px = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[3]));
   npx = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,FieldNumbers[4]));
   y = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[5]));
   ny = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,FieldNumbers[6]));
   py = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[7]));
   npy = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,FieldNumbers[8]));
   delta = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[9]));
   ndelta = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,FieldNumbers[10]));
   t = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[11]));
   nt = (int)mxGetScalar(mxGetFieldByNumber(ElemData,0,FieldNumbers[12]));
   pt1 = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[13]));
   pt2 = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[14]));
   pr1 = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[15]));
   pr2 = mxGetPr(mxGetFieldByNumber(ElemData,0,FieldNumbers[16]));
   returnptr = FieldNumbers;
  }
  break;
  default: {
   mexErrMsgTxt("No match for calling mode in function TaylormapPass\n");
  }
 }
 TaylormapPass(r_in, le, x, nx, px, npx, y, ny, py, npy, delta, ndelta, t, nt,
