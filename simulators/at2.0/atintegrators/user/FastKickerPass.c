...
/*
  ...
  */
  ...
  for (c = 0;c<num_particles;c++){/* Loop over particles */
     ...
     /* Get the turn number to kick on */
     mexCallMATLAB(num_out, output_array, 0, NULL, "when2kick");
     KickFlag = mxGetScalar(output_array[0]);
