...
#elif defined(PCWIN64)
    #include <windows.h>
    #define MEXEXTENSIONSTRING ".mexw64"
    #define PASSMETHODSUBDIRSTRING "\\simulator\\element\\"
    #define LIBRARYHANDLETYPE HINSTANCE
    #define FREELIBFCN(libfilename) FreeLibrary((libfilename))
    #define LOADLIBFCN(libfilename) LoadLibrary((libfilename))
...
{  
    ...
    {   mxPtrELEM[n]= mxGetCell(LATTICE,n);
		...
		/*Next line added by X. Huang, 10/12/2017 to address the crash problem  */
        ...
        {   mexCallMATLAB(1,&tempmxptr2,1,&tempmxptr1,"exist");
            ...
            {   case 2: 
					...
					/*Next line added by X. Huang, 10/12/2017 to address the crash problem  */				
		            mexMakeMemoryPersistent(LibraryListPtr->MethodName);
                ...
                case 3: 
                    ...
                    mxDestroyArray(tempmxptr2);
					/*Next two lines added by X. Huang, 10/12/2017 to address the crash problem  */
					mexMakeMemoryPersistent(LibraryListPtr->MethodName);
                    mexMakeMemoryPersistent(LibraryListPtr->LibraryFileName);
