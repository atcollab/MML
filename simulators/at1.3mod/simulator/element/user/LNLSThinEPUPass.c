...
void LNLSThinEPUPass(double *r, double E, int nx, int ny, double *XEPU, double *YEPU, double *PXEPU, double *PYEPU,
...
{ 
  ...
  char *method;
  int buflen;
  double xkick, ykick, gam, beta, brho;
  int num_in, num_out;
...
#define NUM_FIELDS_2_REMEMBER 12
{
  ...
  LNLSThinEPUPass(r_in, E, nx, ny, XEPU, YEPU, PXEPU, PYEPU, pr1, pr2, pt1, pt2, num_particles);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  r_in = mxGetPr(plhs[0]);
  LNLSThinEPUPass(r_in, E, nx, ny, XEPU, YEPU, PXEPU, PYEPU, pr1, pr2, pt1, pt2, n);
}
